...
export function SummonerShowcase({ id }) {
    ...
    return (_jsxs(Showcase, { id: id, mock: _jsx(MatchCardStack, {}), children: [_jsx(Eyebrow, { children: "Summoner intelligence" }), _jsxs(Headline, { children: ["Look up anyone.", _jsx("br", {}), "See ", _jsx(Hot, { children: "everything" }), "."] }), _jsxs(Lead, { children: ["Search any Riot ID for the whole picture \u2014 every game broken down to runes, items, KDA and the full scoreboard. Then spin up a", " ", _jsx("button", { type: "button", onClick: () => setTutorialOpen(true), className: "scout-cta inline cursor-clicker bg-transparent p-0 align-baseline font-semibold text-jade underline decoration-jade/40 underline-offset-[3px] transition-colors hover:decoration-jade", children: "Scout lobby" }), " ", "to track a whole squad, live, every match."] }), _jsx(Bullets, { items: [
                    { icon: Swords, label: "Matches" },
                    { icon: Crosshair, label: "Champions" },
                    { icon: Radio, label: "Live" },
                    { icon: Users, label: "Scout" },
                ] }), _jsx(motion.div, { variants: up, className: "pt-1", children: _jsx(GhostLink, { onClick: openSearch, children: "Search a summoner" }) }), createPortal(_jsxs(_Fragment, { children: [_jsx("style", { children: `@keyframes scoutCtaGlow{0%,100%{text-shadow:0 0 6px rgba(0,217,146,0.35)}50%{text-shadow:0 0 16px rgba(0,217,146,0.9),0 0 4px rgba(0,217,146,0.7)}}.scout-cta{animation:scoutCtaGlow 1.8s ease-in-out infinite}` }), _jsx(ScoutTutorial, { open: tutorialOpen, onClose: () => setTutorialOpen(false), onDive: () => navigate("/scout/new") })] }), document.body)] }));
}
function MatchCardStack() {
    ...
    _jsxs(motion.div, { className: "relative mx-auto w-full max-w-[600px]", style: { perspective: "1000px" }, initial: "off", whileInView: "on", viewport: { once: true, amount: 0.2 }, variants: { off: {}, on: {} }, children: [_jsx("div", { "aria-hidden": true, className: "absolute -inset-6 -z-10 opacity-60", style: {
                ...
                } }), _jsx(motion.div, { className: "relative space-y-4 md:[transform:rotateY(-15deg)] md:[transform-origin:62%_50%]", variants: { off: {}, on: { transition: { staggerChildren: 0.13 } } }, children: MATCHES.map((m, i) => (
