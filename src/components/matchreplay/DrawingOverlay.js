...
export function DrawingToolbar({ tool, setTool, color, setColor, onClear, onUndo, hasStrokes }) {
    return (_jsxs("div", { className: "absolute top-2 left-2 z-[120] flex flex-col gap-1 pointer-events-auto", children: [_jsxs("div", { className: "flex flex-col gap-0.5 p-1 rounded-sm bg-liquirice/80 backdrop-blur-md ring-1 ring-flash/10 shadow-[0_4px_14px_rgba(var(--c-shadow),0.55)]", children: [_jsx(ToolBtn, { icon: _jsx(MousePointer2, { className: "w-3.5 h-3.5" }), label: "select", active: tool === "off", onClick: () => setTool("off") }), _jsx(ToolBtn, { icon: _jsx(Pen, { className: "w-3.5 h-3.5" }), label: "draw", active: tool === "pen", onClick: () => setTool("pen") }), _jsx(ToolBtn, { icon: _jsx(Eraser, { className: "w-3.5 h-3.5" }), label: "erase", active: tool === "eraser", onClick: () => setTool("eraser") })] }), tool === "pen" && (_jsx("div", { className: "flex flex-col gap-0.5 p-1 rounded-sm bg-liquirice/80 backdrop-blur-md ring-1 ring-flash/10 shadow-[0_4px_14px_rgba(var(--c-shadow),0.55)]", children: DRAW_COLORS.map((c) => (_jsx("button", { type: "button", onClick: () => setColor(c), className: cn("w-5 h-5 rounded-sm cursor-clicker transition-all", color === c ? "ring-2 ring-flash/70 scale-110" : "ring-1 ring-flash/20 hover:scale-105"), style: { background: c }, title: c }, c))) })), hasStrokes && (_jsxs("div", { className: "flex flex-col gap-0.5 p-1 rounded-sm bg-liquirice/80 backdrop-blur-md ring-1 ring-flash/10 shadow-[0_4px_14px_rgba(var(--c-shadow),0.55)]", children: [_jsx(ToolBtn, { icon: _jsx(Undo2, { className: "w-3.5 h-3.5" }), label: "undo", active: false, onClick: onUndo }), _jsx(ToolBtn, { icon: _jsx(Trash2, { className: "w-3.5 h-3.5" }), label: "clear", active: false, onClick: onClear, danger: true })] }))] }));
}
