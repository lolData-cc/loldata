...
export function PremiumAvatarUploader() {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs("div", { className: "relative rounded-[2px] border border-jade/10 bg-cement overflow-hidden", children: [_jsx("div", { className: "absolute left-0 top-0 bottom-0 w-[2px] bg-jade/40" }), _jsx("div", { className: "absolute inset-0 pointer-events-none", style: { background: "repeating-linear-gradient(0deg, transparent, transparent 3px, rgba(255,255,255,0.015) 3px, rgba(255,255,255,0.015) 4px)" } }), _jsxs("div", { className: "absolute top-0 left-0 w-3 h-3 z-[3]", children: [_jsx("div", { className: "absolute top-0 left-0 w-full h-[1px] bg-jade/25" }), _jsx("div", { className: "absolute top-0 left-0 w-[1px] h-full bg-jade/25" })] }), _jsxs("div", { className: "absolute top-0 right-0 w-3 h-3 z-[3]", children: [_jsx("div", { className: "absolute top-0 right-0 w-full h-[1px] bg-jade/25" }), _jsx("div", { className: "absolute top-0 right-0 w-[1px] h-full bg-jade/25" })] }), _jsxs("div", { className: "absolute bottom-0 left-0 w-3 h-3 z-[3]", children: [_jsx("div", { className: "absolute bottom-0 left-0 w-full h-[1px] bg-jade/25" }), _jsx("div", { className: "absolute bottom-0 left-0 w-[1px] h-full bg-jade/25" })] }), _jsxs("div", { className: "absolute bottom-0 right-0 w-3 h-3 z-[3]", children: [_jsx("div", { className: "absolute bottom-0 right-0 w-full h-[1px] bg-jade/25" }), _jsx("div", { className: "absolute bottom-0 right-0 w-[1px] h-full bg-jade/25" })] }), _jsx("div", { className: "absolute bottom-0 left-0 right-0 h-[1px] bg-gradient-to-r from-jade/30 via-jade/10 to-transparent z-[3]" }), _jsxs("div", { className: "relative z-[2] px-4 py-3 pl-5", children: [_jsxs("div", { className: "flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4", children: [_jsx("div", { className: "w-16 h-16 rounded-[2px] overflow-hidden border border-jade/15 bg-black/30 shrink-0", children: avatarUrl ? (_jsx("img", { src: avatarUrl, alt: "Avatar", className: "w-full h-full object-cover" })) : (_jsx("img", { src: `${cdnBaseUrl()}/img/profileicon/29.png`, alt: "", className: "w-full h-full object-cover opacity-30" })) }), _jsx("span", { className: "text-flash/60 text-sm min-w-0 break-words", children: isPremium
                                            ...
                                            : "Upgrade to Premium to customize your avatar." })] }), _jsx("div", { className: "mt-3 h-[1px] bg-gradient-to-r from-jade/15 via-flash/8 to-transparent" }), _jsxs("div", { className: "flex flex-wrap justify-between items-center gap-2 pt-2", children: [_jsx("span", { className: "text-[10px] font-mono text-flash/30 tracking-[0.08em]", children: isPremium ? "◈ PREMIUM" : "◈ FREE TIER" }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsx("button", { type: "button", onClick: handleReset, disabled: uploading || !avatarUrl, className: "px-2 py-1 rounded-[2px] border border-flash/15 hover:bg-flash/5 text-[11px] tracking-[0.1em] uppercase text-flash/50 cursor-clicker transition-colors disabled:opacity-40 disabled:pointer-events-none", children: "RESET" }), isPremium ? (_jsxs("label", { className: cn("px-2 py-1 rounded-[2px] cursor-clicker border border-jade/30 text-jade hover:bg-jade/10 text-[11px] tracking-[0.1em] uppercase transition-colors inline-flex items-center gap-1", uploading && "opacity-60 pointer-events-none"), children: [uploading ? "UPLOADING..." : "UPLOAD", _jsx("input", { type: "file", accept: "image/*", className: "hidden", onChange: (e) => {
                                                            ...
                                                            setFileToCrop(f);
                                                        } })] })) : (_jsx("span", { className: "text-[10px] text-flash/30 font-mono tracking-[0.1em]", children: "PREMIUM ONLY" }))] })] })] })] }), fileToCrop && (_jsx(AvatarCropper, { file: fileToCrop, onCancel: () => setFileToCrop(null), onCropped: (blob) => uploadBlob(blob) }))] }));
}
