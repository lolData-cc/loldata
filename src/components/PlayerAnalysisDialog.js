...
function StatPill({ label, value, sub }) {
    return (_jsxs("div", { className: "flex flex-col items-center gap-0.5 px-3 py-2 rounded-sm bg-filmlight/[0.03] border border-hairline/[0.06]", children: [_jsx("span", { className: "text-[9px] tracking-[0.15em] uppercase text-flash/30 font-jetbrains", children: label }), _jsx("span", { className: "text-[15px] font-jetbrains font-medium text-flash/90", children: value }), sub && (_jsx("span", { className: "text-[9px] text-flash/25 font-jetbrains", children: sub }))] }));
}
// ── Bar ──────────────────────────────────────────────────────────────
function PctBar({ pct, color = AC, label, sub }) {
    return (_jsxs("div", { className: "flex items-center gap-3 py-1", children: [_jsx("span", { className: "w-[70px] text-right text-[10px] font-jetbrains text-flash/50 uppercase tracking-wider shrink-0", children: label }), _jsx("div", { className: "flex-1 h-[6px] bg-filmlight/[0.06] rounded-sm overflow-hidden", children: _jsx(motion.div, { initial: { width: 0 }, animate: { width: `${Math.min(pct, 100)}%` }, transition: { duration: 0.6, ease: "easeOut" }, className: "h-full rounded-sm", style: { background: color } }) }), _jsxs("span", { className: "w-[42px] text-[10px] font-jetbrains text-flash/60", children: [pct, "%"] }), sub && (_jsx("span", { className: "text-[9px] font-jetbrains text-flash/30 w-[40px]", children: sub }))] }));
}
// ── Results Sections ─────────────────────────────────────────────────
...
export function ChampionPoolSection({ data }) {
    ...
    return (_jsx(SectionCard, { title: "Champion Pool", tag: "CHAMPS", delay: 0.2, children: _jsx("div", { className: "space-y-2", children: top5.map((c) => (_jsxs("div", { className: "flex items-center gap-3 py-1", children: [_jsx("img", { src: `${cdnBaseUrl()}/img/champion/${c.championName}.png`, alt: c.championName, className: "w-7 h-7 rounded-sm border border-hairline/10" }), _jsx("span", { className: "w-[80px] text-[11px] font-jetbrains text-flash/80 truncate", children: c.championName }), _jsxs("span", { className: "text-[10px] font-jetbrains text-flash/40 w-[30px]", children: [c.games, "g"] }), _jsx("div", { className: "flex-1 h-[6px] bg-filmlight/[0.06] rounded-sm overflow-hidden", children: _jsx(motion.div, { initial: { width: 0 }, animate: { width: `${c.winrate}%` }, transition: { duration: 0.6, ease: "easeOut" }, className: "h-full rounded-sm", style: { background: c.winrate >= 50 ? AC : ERROR_COLOR } }) }), _jsxs("span", { className: "w-[38px] text-[10px] font-jetbrains font-medium", style: { color: c.winrate >= 50 ? AC : ERROR_COLOR }, children: [c.winrate, "%"] }), _jsxs("span", { className: "text-[10px] font-jetbrains text-flash/40 w-[50px] text-right", children: [c.avgKda, " KDA"] })] }, c.championName))) }) }));
}
...
function BootsDistributionSection({ data }) {
    ...
    return (_jsx(SectionCard, { title: "Boots Buy Distribution", tag: "ITEMS", delay: 0.6, accentColor: "#8b5cf6", children: _jsxs("div", { className: "space-y-2", children: [_jsxs("div", { className: "flex items-center gap-3 pb-1", children: [_jsx("div", { className: "w-7 shrink-0" }), _jsx("div", { className: "w-[110px] shrink-0" }), _jsx("div", { className: "flex-1" }), _jsx("span", { className: "w-[38px] text-[9px] font-jetbrains text-flash/30 text-right uppercase", children: "Pick" }), _jsx("span", { className: "w-[38px] text-[9px] font-jetbrains text-flash/30 text-right uppercase", children: "WR" }), _jsx("div", { className: "w-[24px]" })] }), filtered.map((b) => {
                    ...
                    return (_jsxs("div", { className: "flex items-center gap-3 py-1", children: [itemId ? (_jsx("img", { src: `${cdnBaseUrl()}/img/item/${itemId}.png`, alt: b.boots, className: "w-7 h-7 rounded-sm border border-hairline/10 shrink-0" })) : (_jsx("div", { className: "w-7 h-7 rounded-sm bg-filmlight/5 border border-hairline/10 shrink-0" })), _jsx("span", { className: "w-[110px] text-[10px] font-jetbrains text-flash/60 truncate shrink-0", children: b.boots }), _jsx("div", { className: "flex-1 h-[6px] bg-filmlight/[0.06] rounded-sm overflow-hidden", children: _jsx(motion.div, { initial: { width: 0 }, animate: { width: `${Math.min(b.pct, 100)}%` }, transition: { duration: 0.6, ease: "easeOut" }, className: "h-full rounded-sm", style: { background: color } }) }), _jsxs("span", { className: "w-[38px] text-[10px] font-jetbrains font-medium text-flash/70 text-right", children: [b.pct, "%"] }), _jsxs("span", { className: "w-[38px] text-[10px] font-jetbrains font-medium text-right", style: { color: b.winRate >= 50 ? "#4ade80" : "#f87171" }, children: [b.winRate, "%"] }), _jsxs("span", { className: "w-[24px] text-[9px] font-jetbrains text-flash/30 text-right", children: [b.count, "g"] })] }, b.boots));
                })] }) }));
}
function EarlyGameSection({ data }) {
    ...
    return (_jsx(SectionCard, { title: "Early Game Impact (Pre-10 min)", tag: "EARLY", delay: 0.65, accentColor: "#3b82f6", children: _jsxs("div", { className: "space-y-4", children: [_jsx("div", { className: "space-y-3", children: bars.map((b) => (_jsxs("div", { children: [_jsxs("div", { className: "flex items-center justify-between mb-1", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx("span", { className: "text-[10px] font-jetbrains font-medium tracking-[0.1em]", style: { color: b.color }, children: b.label }), _jsx("span", { className: "text-[9px] font-jetbrains text-flash/25", children: b.desc })] }), _jsxs("span", { className: "text-[10px] font-jetbrains text-flash/40", children: [b.games, "g \u2014 ", b.wins, "W ", b.games - b.wins, "L"] })] }), _jsxs("div", { className: "flex items-center gap-3", children: [_jsx("div", { className: "flex-1 h-[8px] bg-filmlight/[0.04] rounded-sm overflow-hidden", children: b.games > 0 && (_jsx(motion.div, { initial: { width: 0 }, animate: { width: `${(b.games / maxGames) * 100}%` }, transition: { duration: 0.6, ease: "easeOut" }, className: "h-full rounded-sm relative overflow-hidden", style: { background: `color-mix(in srgb, ${b.color} 30%, transparent)` }, children: _jsx(motion.div, { initial: { width: 0 }, animate: { width: `${b.winrate}%` }, transition: { duration: 0.8, ease: "easeOut", delay: 0.3 }, className: "h-full rounded-sm", style: { background: b.color } }) })) }), _jsx("span", { className: "w-[42px] text-[11px] font-jetbrains font-medium text-right", style: { color: b.games > 0 ? (b.winrate >= 50 ? AC : ERROR_COLOR) : "rgba(215,216,217,0.2)" }, children: b.games > 0 ? `${b.winrate}%` : "—" })] })] }, b.label))) }), _jsxs("div", { className: "grid grid-cols-4 gap-2 pt-2 border-t border-hairline/[0.06]", children: [_jsxs("div", { className: "flex flex-col items-center gap-0.5 px-2 py-2 rounded-sm bg-filmlight/[0.03] border border-hairline/[0.06]", children: [_jsx("span", { className: "text-[8px] tracking-[0.15em] uppercase text-flash/30 font-jetbrains", children: "AVG KILL DIFF" }), _jsxs("span", { className: "text-[14px] font-jetbrains font-medium", style: { color: eg.avgKillDiffAtTen >= 0 ? AC : ERROR_COLOR }, children: [eg.avgKillDiffAtTen >= 0 ? "+" : "", eg.avgKillDiffAtTen] })] }), _jsxs("div", { className: "flex flex-col items-center gap-0.5 px-2 py-2 rounded-sm bg-filmlight/[0.03] border border-hairline/[0.06]", children: [_jsx("span", { className: "text-[8px] tracking-[0.15em] uppercase text-flash/30 font-jetbrains", children: "AVG GOLD DIFF" }), _jsxs("span", { className: "text-[14px] font-jetbrains font-medium", style: { color: eg.avgGoldDiffAtTen >= 0 ? AC : ERROR_COLOR }, children: [eg.avgGoldDiffAtTen >= 0 ? "+" : "", eg.avgGoldDiffAtTen] })] }), _jsxs("div", { className: "flex flex-col items-center gap-0.5 px-2 py-2 rounded-sm bg-filmlight/[0.03] border border-hairline/[0.06]", children: [_jsx("span", { className: "text-[8px] tracking-[0.15em] uppercase text-flash/30 font-jetbrains", children: "AVG CS DIFF" }), _jsxs("span", { className: "text-[14px] font-jetbrains font-medium", style: { color: eg.avgCsDiffAtTen >= 0 ? AC : ERROR_COLOR }, children: [eg.avgCsDiffAtTen >= 0 ? "+" : "", eg.avgCsDiffAtTen] })] }), _jsxs("div", { className: "flex flex-col items-center gap-0.5 px-2 py-2 rounded-sm bg-filmlight/[0.03] border border-hairline/[0.06]", children: [_jsx("span", { className: "text-[8px] tracking-[0.15em] uppercase text-flash/30 font-jetbrains", children: "FIRST BLOOD" }), _jsxs("span", { className: "text-[14px] font-jetbrains font-medium text-flash/80", children: [eg.firstBloodRate, "%"] }), eg.firstBloodRate > 0 && (_jsxs("span", { className: "text-[8px] font-jetbrains", style: { color: eg.firstBloodWinrate >= 50 ? AC : ERROR_COLOR }, children: [eg.firstBloodWinrate, "% WR"] }))] })] })] }) }));
}
...
// ── Main Component ───────────────────────────────────────────────────
export function PlayerAnalysisDialog({ puuid, region, summonerName, externalOpen, onExternalOpenChange, fill, }) {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs("div", { className: cn("relative inline-flex flex-col items-center", fill && "w-full"), children: [_jsx(ActionButton, { accent: "jade", label: "ANALYZE", muted: isLocked, fill: fill, disabled: !puuid, onClick: () => {
                            if (isLocked) {
                                setPaywallReason("limit");
                                setShowPaywall(true);
                            }
                            ...
                            }, children: [_jsx(HudCorners, {}), _jsx("div", { className: "absolute left-0 top-0 bottom-0 w-[2px] z-[4]", style: { background: AC, boxShadow: `0 0 8px ${AC_GLOW}` } }), _jsxs("div", { className: "relative z-[5]", children: [_jsxs("div", { className: "px-6 pt-5 pb-3 border-b border-hairline/[0.06]", children: [_jsxs("div", { className: "flex items-center gap-2 text-[10px] tracking-[0.25em] uppercase mb-1", style: { color: `color-mix(in srgb, ${AC} 50%, transparent)` }, children: [_jsx("span", { style: { color: AC, fontSize: "8px" }, children: "\u25C8" }), _jsx("span", { children: "::" }), _jsx("span", { className: "px-1.5 py-[1px]", style: {
                                                                color: AC,
                                                                background: AC_DIM,
