    ...
    <Dialog onOpenChange={setOpen}>
      ...
      >
        <div className="flex justify-between gap-8">
          <div className="text-[11px] bg-[#1f1f1f] w-[45%] h-[300px] p-4 overflow-y-auto rounded-md border border-white/10">
            ...
            <div className="flex flex-col space-y-3">
              {(["top", "jungle", "mid", "bot", "support"] as const).map(role => {
                ...
                return p ? (
                  <div key={p.summonerName} className="flex items-center justify-between">
                    ...
                    <div className="flex flex-col gap-1 text-white/80 font-jetbrains">
                      <span>{ranks[p.riotId]?.rank || "..."} {ranks[p.riotId]?.lp}</span>
                    </div>

                    <div className="flex flex-col gap-1 text-white/80 font-jetbrains">
                      <span>{ranks[p.riotId]?.wins}W / {ranks[p.riotId]?.losses}L</span>
                    </div>
                  </div>
                ) : null
              })}
          ...
          <div className="text-[8px] bg-red-900 w-[45%] h-[300px] p-4 overflow-y-auto rounded-md">
          ...
          <div className="w-full bg-[#1f1f1f] text-white p-4 rounded text-sm shadow-lg border border-white/10 max-h-[300px] flex flex-col">
            ...
            >
              ...
              <TabsList className="bg-[#1f1f1f] space-x-4 font-jetbrains justify-start">
                ...
                >
                  <div>HOW TO WIN</div>
                  <div className="px-1 text-[#00D992] rounded-sm bg-[#11382E] group-data-[state=active]:bg-[#00D992] group-data-[state=active]:text-[#11382E]">
                    AI
                  </div>
                </TabsTrigger>
