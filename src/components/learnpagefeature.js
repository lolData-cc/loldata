...
const BULLET_ICON_CLS = "w-4 h-4 mx-2 flex-shrink-0 text-[#008C5A] fill-[#008C5A]";
const FEATURES = [
    {
...
// ─── Render helpers ──────────────────────────────────────────────────
function BulletGlyph({ node }) {
    if (node.kind === "img") {
        return (_jsx("img", { src: node.src, alt: node.alt, className: "w-4 h-4 mx-2 flex-shrink-0" }));
    }
    const Icon = node.icon;
    return _jsx(Icon, { className: BULLET_ICON_CLS });
}
/**
 ...
 */
function FeatureBlock({ feature, className, mobile = false, }) {
    const Icon = feature.icon;
    return (_jsxs(motion.div, { className: className, variants: containerVariants, initial: "hidden", whileInView: "show", viewport: VIEWPORT, children: [_jsx(motion.div, { variants: headerVariants, children: _jsxs("div", { className: "group flex gap-4 items-center cursor-clicker", children: [_jsx("div", { className: "\n              z-10 bg-jade/20 w-6 h-6 flex-shrink-0\n              flex items-center justify-center rounded-[3px]\n              transition-all duration-300\n              group-hover:bg-jade/35\n              group-hover:scale-110\n              group-hover:shadow-[0_0_16px_rgba(0,217,146,0.45)]\n            ", children: _jsx(Icon, { "aria-hidden": true, className: "text-jade size-5 pointer-events-none transition-transform duration-300 group-hover:scale-110" }) }), _jsxs("div", { className: "flex items-center text-flash/90 gap-1.5 transition-colors duration-300 group-hover:text-flash", children: [_jsx("span", { className: mobile ? "text-lg" : "text-lg lg:text-xl", children: feature.title }), _jsx(ChevronRight, { className: "\n                w-4 h-4 transform transition-transform duration-300\n                group-hover:translate-x-1.5 group-hover:text-jade\n              " })] })] }) }), _jsx(motion.div, { variants: bodyVariants, className: mobile
                    ? "ml-9 text-flash/75 font-geist font-extralight text-[14px]"
                    : "w-full lg:w-[45%] ml-10 text-flash/75 font-geist font-extralight text-[14px]", children: feature.body }), _jsx(motion.div, { variants: bulletListVariants, className: mobile
                    ? "ml-9 pt-3"
                    : "w-full lg:w-[45%] ml-10 text-[14px] pt-4", children: _jsxs("div", { className: "space-y-2 text-sm text-flash/30 uppercase font-jetbrains", children: [feature.bullets.map((b, idx) => (_jsxs(motion.div, { variants: bulletVariants, children: [_jsx(Separator, { className: "w-full bg-flash/10" }), _jsxs("div", { className: "flex items-center pt-2", children: [_jsx(BulletGlyph, { node: b.node }), b.label] })] }, idx))), _jsx(motion.div, { variants: bulletVariants, children: _jsx(Separator, { className: "w-full bg-flash/10" }) })] }) })] }));
}
// ─── Decorative "@" rail ─────────────────────────────────────────────
...
function DecorativeAtRail({ length = 40 }) {
    return (_jsx(motion.div, { className: "hidden lg:flex flex-col items-center h-[600px]", initial: { opacity: 0 }, whileInView: { opacity: 1 }, viewport: { once: true, amount: 0.3 }, transition: { duration: 1.2, ease: EASE_BRAND, delay: 0.2 }, children: Array.from({ length }).map((_, i) => {
...
export function LearnPageFeature() {
    return (_jsxs("div", { className: "relative", children: [_jsx("div", { "aria-hidden": true, className: "\n          absolute inset-x-0 top-0 h-[1100px] -z-10\n          pointer-events-none opacity-[0.07]\n          [background-image:radial-gradient(rgba(0,217,146,0.6)_1px,transparent_1px)]\n          [background-size:22px_22px]\n          [mask-image:radial-gradient(ellipse_at_center,black_15%,transparent_70%)]\n          [-webkit-mask-image:radial-gradient(ellipse_at_center,black_15%,transparent_70%)]\n        " }), _jsx(TypingOnInView, { text: "Explore lolData features", speed: 50, className: "text-xl sm:text-2xl md:text-3xl text-jade py-6 font-scifi" }), _jsx(Separator, { className: "relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] w-screen border-t border-flash/20" }), _jsxs("div", { className: "hidden md:flex justify-between px-6 lg:px-24", children: [_jsxs("div", { className: "relative w-full h-[1000px]", children: [_jsx(Separator, { className: "\n              w-[50%]\n              h-[1000px]\n              border-x border-transparent\n              [border-image-slice:1]\n              [border-image-source:linear-gradient(to_bottom,currentColor,transparent)]\n              text-flash/20\n            " }), _jsx(FeatureBlock, { feature: FEATURES[0], className: "absolute top-24 right-full -left-3 z-10 w-full space-y-3" }), _jsx(FeatureBlock, { feature: FEATURES[1], className: "absolute top-[550px] right-full -left-3 z-10 w-full space-y-3" })] }), _jsx(DecorativeAtRail, {})] }), _jsxs("div", { className: "md:hidden px-4 py-8 space-y-10", children: [_jsx(FeatureBlock, { feature: FEATURES[0], mobile: true, className: "space-y-3" }), _jsx(FeatureBlock, { feature: FEATURES[1], mobile: true, className: "space-y-3" })] })] }));
}
