...
const RINGS = [
    {
        size: 150, anim: "sboOrbit1", speed: 8, borderStyle: "dashed",
    ...
    {
        size: 196, anim: "sboOrbit2", speed: 11, borderStyle: "dashed",
    ...
    {
        size: 240, anim: "sboOrbit3", speed: 15, borderStyle: "dotted",
...
`;
export function SummonerBootOverlay({ active }) {
    ...
    return (_jsxs("div", { className: "lg:hidden fixed inset-0 z-[80] flex flex-col items-center justify-center overflow-hidden bg-liquirice", style: {
            clipPath: phase === "wipe" ? "circle(0% at 50% 44%)" : "circle(142% at 50% 44%)",
            transition: `clip-path ${WIPE_MS}ms cubic-bezier(0.22,1,0.36,1)`,
        }, "aria-hidden": true, children: [_jsx("style", { children: BOOT_CSS }), _jsx("div", { className: "pointer-events-none absolute inset-0 overflow-hidden", children: PARTICLES.map((p, i) => (_jsx("span", { className: "sbo-anim absolute bottom-[-20px] text-jade select-none", style: {
                        left: `${p.x}%`,
                        fontSize: p.size,
                        opacity: p.op,
                        animation: `sboFloat ${p.dur}s linear infinite`,
                        animationDelay: `${p.delay}s`,
                    }, children: p.char }, i))) }), _jsx("div", { className: "pointer-events-none absolute inset-0 opacity-[0.04]", style: { backgroundImage: "repeating-linear-gradient(0deg, transparent, transparent 2px, rgba(255,255,255,0.15) 2px, rgba(255,255,255,0.15) 4px)" } }), _jsx("div", { className: "pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_center,transparent_20%,rgba(4,10,12,0.85)_70%,rgba(4,10,12,1)_100%)]" }), _jsx("div", { className: "pointer-events-none absolute inset-0 bg-[radial-gradient(circle_420px_at_50%_44%,rgba(0,217,146,0.05)_0%,transparent_70%)]" }), _jsxs("div", { className: "relative -mt-14 flex h-[260px] w-[260px] items-center justify-center", style: { perspective: "700px" }, children: [RINGS.map((ring, ri) => (_jsxs("div", { className: "sbo-anim absolute", style: {
                            width: ring.size,
                            height: ring.size,
                            animation: `${ring.anim} ${ring.speed}s linear infinite`,
                        }, children: [_jsx("div", { className: "absolute inset-0 rounded-full transition-colors duration-300", style: {
                                    borderWidth: 1,
                            ...
                            })] }, ri))), _jsx("span", { className: cn("relative z-10 select-none font-chakrapetch text-[44px] leading-none text-jade", locked ? "sbo-glyph-locked" : "sbo-glyph"), children: "\u25C8" }), locked && _jsx("span", { className: "sbo-ring absolute inset-12" })] }), _jsxs("div", { className: "mt-5 flex h-4 items-center gap-2.5", children: [_jsx("span", { className: cn("h-[5px] w-[5px] rotate-45", locked ? "bg-jade shadow-[0_0_8px_rgba(0,217,146,0.9)]" : "sbo-dot bg-jade/70") }), _jsx("span", { className: cn("sbo-line font-jetbrains text-[10px] uppercase tracking-[0.3em]", locked ? "text-jade" : "text-flash/50"), children: locked ? "Summoner found" : LINES[lineIdx] }, locked ? "locked" : lineIdx)] }), _jsx("div", { className: "mt-4 h-[2px] w-[180px] overflow-hidden rounded-full bg-flash/[0.07]", children: _jsx("div", { className: cn("h-full rounded-full", locked ? "w-full bg-jade transition-all duration-300" : "sbo-sweep w-1/3 bg-jade/70") }) }), _jsxs("span", { className: "absolute bottom-10 select-none font-chakrapetch text-[11px] uppercase tracking-[0.4em] text-flash/15", children: ["lol", _jsx("span", { className: "text-jade/30", children: "\u25C8" }), "data"] })] }));
}
