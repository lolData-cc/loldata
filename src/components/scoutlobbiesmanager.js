...
export default function ScoutLobbiesManager() {
    ...
    if (loading) {
        return (_jsx("div", { className: "space-y-3", children: [0, 1, 2].map((i) => (_jsx("div", { className: "h-16 rounded-[2px] border border-flash/8 bg-filmdark/20 animate-pulse" }, i))) }));
    }
    if (error || !data) {
    ...
    return (_jsxs("div", { className: "space-y-4", children: [_jsx("div", { className: "relative overflow-hidden rounded-md bg-filmlight/[0.04] backdrop-blur-lg saturate-150 shadow-[0_10px_30px_rgba(var(--c-shadow),0.45),inset_0_0_0_1px_rgba(255,255,255,0.14),inset_0_1px_0_rgba(255,255,255,0.10)]", children: _jsxs("div", { className: "relative z-[1] px-4 py-3 flex items-center justify-between gap-4", children: [_jsxs("div", { className: "min-w-0", children: [_jsxs("div", { className: "flex items-center gap-2 mb-0.5", children: [_jsx("h4", { className: "text-[11px] font-mono tracking-[0.25em] uppercase text-jade/50", children: "Your Plan" }), _jsxs("span", { className: cn("inline-flex items-center gap-1 text-[9px] font-mono font-bold tracking-[0.2em] px-1.5 py-[1px] rounded-sm border", data.plan === "free"
