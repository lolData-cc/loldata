    ...
    const slotCard = (roleIdx) => {
        ...
        return (_jsx("div", { style: { opacity: 0, animation: `pentSlotIn 0.45s ease-out ${DELAYS[roleIdx]}s forwards` }, children: _jsxs("button", { type: "button", onClick: () => {
                    ...
                    : opp
                        ...
                        : "border-hairline/[0.06] bg-filmlight/[0.02] hover:border-jade/30 hover:bg-filmlight/[0.03]"), children: [_jsxs("div", { className: "flex items-center gap-2 mb-2", children: [_jsx(r.Icon, { className: cn("w-4 h-4", opp ? "text-jade" : "text-flash/30") }), _jsx("span", { className: cn("text-[9px] font-jetbrains uppercase tracking-[0.15em]", opp ? "text-jade" : "text-flash/25"), children: r.label })] }), _jsx("div", { className: "border-t border-hairline/[0.06] pt-2", children: opp ? (_jsxs("div", { className: "flex items-center gap-2", children: [_jsx("img", { src: `${cdnBaseUrl()}/img/champion/${opp.name}.png`, alt: opp.name, className: "w-6 h-6 rounded-sm" }), _jsx("span", { className: "text-[10px] font-jetbrains text-flash/80 truncate flex-1 text-left", children: opp.name }), _jsx("span", { onClick: (e) => { e.stopPropagation(); onClearOpponent(r.key); }, className: "text-flash/20 hover:text-flash text-xs cursor-clicker transition-colors", children: "\u2715" })] })) : (_jsx("span", { className: cn("text-[10px] font-jetbrains uppercase tracking-[0.15em]", isActive ? "text-jade" : "text-flash/20"), children: "+ Add" })) })] }) }, r.key));
    };
                        ...
                        return (_jsx("div", { className: "absolute", style: {
                                ...
                                animation: `pentSlotIn 0.35s ease-out ${0.04 + i * 0.07}s forwards`,
                                    ...
                                    : opp
                                        ...
                                        : "border-hairline/15 shadow-[0_0_8px_rgba(255,255,255,0.03)] hover:border-hairline/25 cursor-clicker"), children: [_jsxs("div", { className: "flex items-center gap-3 mb-3", children: [_jsx(r.Icon, { className: cn("w-6 h-6", opp ? "text-jade" : "text-flash/25") }), _jsx("span", { className: cn("text-[12px] font-jetbrains uppercase tracking-[0.18em]", opp ? "text-jade" : "text-flash/20"), children: r.label })] }), _jsx("div", { className: "border-t border-hairline/[0.06] pt-3", children: opp ? (_jsxs("div", { className: "space-y-2", children: [_jsxs("div", { className: "flex items-center gap-3", children: [_jsx("img", { src: `${cdnBaseUrl()}/img/champion/${opp.name}.png`, alt: opp.name, className: "w-8 h-8 rounded-sm" }), _jsx("span", { className: "text-[13px] font-jetbrains text-flash/80 truncate flex-1 text-left", children: opp.name }), _jsx("span", { onClick: (e) => { e.stopPropagation(); onClearOpponent(r.key); }, className: "text-flash/20 hover:text-flash text-sm cursor-clicker transition-colors", children: "\u2715" })] }), _jsx("div", { className: "flex items-center gap-2 pl-1 mt-1", children: opp.itemId ? (_jsxs(_Fragment, { children: [_jsx("img", { src: `${cdnBaseUrl()}/img/item/${opp.itemId}.png`, alt: opp.itemName ?? "", className: "w-5 h-5 rounded-sm" }), _jsx("span", { className: "text-[10px] font-jetbrains text-flash/50 truncate flex-1 text-left", children: opp.itemName }), _jsx("span", { onClick: (e) => { e.stopPropagation(); onClearItem(r.key); }, className: "text-flash/15 hover:text-flash text-[10px] cursor-clicker transition-colors", children: "\u2715" })] })) : (_jsxs("span", { onClick: (e) => {
                                                            e.stopPropagation();
...
export function ChampionStats({ champ, patch, keyToId, onVsChange, initialVs, }) {
    ...
    const champIconFromKey = (k) => `${cdnBaseUrl()}/img/champion/${champIdFromKey(k)}.png`;
