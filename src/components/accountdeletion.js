...
export function AccountDeletion() {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs(SettingsCard, { title: "Danger zone", variant: "danger", hint: "\u25C8 IRREVERSIBLE", children: [_jsx("p", { className: "text-flash/20 text-[11px]", children: "Permanently remove your account and all associated data." }), _jsx("div", { className: "mt-3 h-[1px] bg-gradient-to-r from-error/15 via-flash/5 to-transparent" }), _jsx("div", { className: "flex justify-end items-center pt-2", children: _jsx("button", { type: "button", onClick: handleOpen, className: "px-2 py-1 rounded-[2px] border border-error/20 text-error/50 hover:text-error hover:border-error/40 hover:bg-error/5 text-[11px] tracking-[0.1em] uppercase cursor-clicker transition-colors shrink-0", children: "DELETE" }) })] }), _jsx(Dialog, { open: dialogOpen, onOpenChange: (open) => { if (!open)
