...
export function TreeLoader() {
    return (_jsxs("div", { className: "w-full h-full flex flex-col items-center justify-center gap-6 select-none", children: [_jsx("style", { children: CSS }), _jsxs("div", { className: "itl-wrap relative w-28 h-28", children: [_jsx("div", { className: "itl-glow absolute inset-0 rounded-full", style: { background: "radial-gradient(circle, rgba(0,217,146,0.22), transparent 62%)" } }), _jsxs("svg", { viewBox: "-50 -50 100 100", className: "absolute inset-0 w-full h-full overflow-visible", children: [_jsx("rect", { className: "itl-spin", x: "-34", y: "-34", width: "68", height: "68", rx: "4", fill: "none", stroke: "#00d992", strokeOpacity: "0.5", strokeWidth: "1.4" }), _jsx("rect", { className: "itl-spin-r", x: "-22", y: "-22", width: "44", height: "44", rx: "3", fill: "none", stroke: "#00d992", strokeOpacity: "0.28", strokeWidth: "1.2" }), _jsx("g", { className: "itl-dot", children: _jsx("circle", { cx: "0", cy: "-34", r: "2.4", fill: "#00d992" }) }), _jsx("circle", { className: "itl-core", cx: "0", cy: "0", r: "7", fill: "#00d992", style: { filter: "drop-shadow(0 0 6px rgba(0,217,146,0.8))" } })] })] }), _jsx("span", { className: "itl-label font-mono text-[10px] tracking-[0.32em] uppercase text-flash", children: "Reading your timelines" })] }));
}
