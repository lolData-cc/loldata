...
const RINGS = [
    {
        size: 280, speed: 8, anim: "learn-orbit-1", borderStyle: "dashed",
    ...
    {
        size: 350, speed: 11, anim: "learn-orbit-2", borderStyle: "dashed",
    ...
    {
        size: 420, speed: 15, anim: "learn-orbit-3", borderStyle: "dotted",
...
export function OrbitEmpty({ label }) {
    return (_jsxs("div", { className: "flex flex-col items-center justify-center py-8", children: [_jsxs("div", { className: "relative w-[340px] h-[340px] flex items-center justify-center", style: { perspective: "800px" }, children: [RINGS.map((ring, ri) => (_jsxs("div", { className: "absolute", style: {
                            width: ring.size,
                            height: ring.size,
                            animation: `${ring.anim} ${ring.speed}s linear infinite`,
                        }, children: [_jsx("div", { className: "absolute inset-0 rounded-full", style: { borderWidth: `${ring.borderWidth}px`, borderStyle: ring.borderStyle, borderColor: ring.borderColor } }), ring.items.map((item, ii) => {
                            ...
                            })] }, ri))), _jsx("div", { className: "relative z-10 w-8 h-8 rounded-full shadow-[0_0_30px_rgba(0,217,146,0.4),0_0_60px_rgba(0,217,146,0.15)]", style: {
                        ...
                        } })] }), label && (_jsx("span", { className: "text-flash/40 font-mechano text-[15px] tracking-[0.2em] uppercase mt-4 text-center", children: label })), _jsx("style", { children: `
