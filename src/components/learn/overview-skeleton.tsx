  ...
  return (
    <div className="space-y-4 animate-pulse">
      ...
      <div className="grid grid-cols-4 gap-3">
        {[1, 2, 3, 4].map(i => (
          <div key={i} className="bg-filmdark/30 border border-flash/[0.06] rounded-sm p-3 h-20">
      ...
      {/* Chart */}
      <div className="bg-filmdark/30 border border-flash/[0.06] rounded-sm p-3 h-44">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="bg-filmdark/30 border border-flash/[0.06] rounded-sm p-3 h-24">
