...
export default function RiotCallbackPage() {
    ...
    return (_jsx("div", { className: "min-h-screen flex items-center justify-center bg-[#060F11]", children: _jsxs("div", { className: "flex flex-col items-center gap-4", children: [_jsx("div", { className: "w-8 h-8 border-2 border-jade/30 border-t-jade rounded-full animate-spin" }), _jsx("span", { className: "font-mono text-[11px] text-flash/40 tracking-[0.2em] uppercase", children: status })] }) }));
}
