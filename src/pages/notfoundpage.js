...
export default function NotFoundPage() {
    ...
    return (_jsxs("div", { className: "relative min-h-screen bg-liquirice text-flash overflow-hidden", children: [_jsx("div", { className: "absolute inset-0 z-[1] pointer-events-none overflow-hidden", children: particles.map((p) => (_jsx("span", { className: "absolute text-jade animate-[heroFloat_linear_infinite]", style: {
                        left: `${p.x}%`,
                        bottom: `-${p.startY}px`,
                        fontSize: `${p.size}px`,
                        opacity: p.opacity,
                    ...
                    }, children: p.char }, p.id))) }), _jsx("div", { className: "absolute inset-0 z-[2] pointer-events-none opacity-[0.04]", style: {
                    backgroundImage: "repeating-linear-gradient(0deg, transparent, transparent 2px, rgba(255,255,255,0.15) 2px, rgba(255,255,255,0.15) 4px)",
                } }), _jsx("div", { className: "absolute inset-0 z-[3] pointer-events-none bg-[radial-gradient(ellipse_at_center,transparent_20%,rgba(4,10,12,0.85)_70%,rgba(4,10,12,1)_100%)]" }), _jsx("div", { className: "absolute inset-0 z-[4] pointer-events-none bg-[radial-gradient(circle_600px_at_50%_40%,rgba(0,217,146,0.04)_0%,transparent_70%)]" }), _jsxs("div", { className: "relative z-10 flex flex-col items-center min-h-screen", children: [_jsx("div", { className: "w-full", children: _jsx("div", { className: "w-[65%] mx-auto", children: _jsx(Navbar, {}) }) }), _jsxs("div", { className: "flex-1 flex flex-col items-center justify-center gap-6 -mt-10 px-4", children: [_jsx("div", { className: "font-mono text-[10px] tracking-[0.3em] uppercase text-error/50 select-none", children: ":: SYSTEM_ERR :: STATUS_404 ::" }), _jsxs("div", { className: "relative w-[280px] h-[280px] md:w-[400px] md:h-[400px] flex items-center justify-center", style: { perspective: "800px" }, children: [ORBIT_RINGS.map((ring, ri) => {
                                        ...
                                        return (_jsxs("div", { className: "absolute", style: {
                                                ...
                                                animation: `${ring.anim} ${ring.speed}s linear infinite`,
                                                    ...
                                                    return (_jsx("span", { className: "absolute select-none", style: {
                                                            left: `${x}%`,
                                                            top: `${y}%`,
                                                            ...
                                                            filter: item.glow
                                                                ...
                                                                : undefined,
                                                        }, children: item.char }, ii));
                                                })] }, ri));
                                    }), _jsxs("div", { className: "relative z-10 flex items-center justify-center select-none", children: [_jsx("span", { className: "text-[80px] md:text-[120px] lg:text-[160px] font-mechano text-flash/90 leading-none animate-[notfound-glow_4s_ease-in-out_infinite]", children: "404" }), _jsx("span", { className: "absolute inset-0 flex items-center justify-center text-[80px] md:text-[120px] lg:text-[160px] font-mechano text-jade/20 leading-none animate-[glitch404-1_4s_infinite]", style: { clipPath: "inset(20% 0 60% 0)" }, "aria-hidden": "true", children: "404" }), _jsx("span", { className: "absolute inset-0 flex items-center justify-center text-[80px] md:text-[120px] lg:text-[160px] font-mechano text-error/15 leading-none animate-[glitch404-2_4s_infinite]", style: { clipPath: "inset(60% 0 10% 0)" }, "aria-hidden": "true", children: "404" })] })] }), _jsx("h1", { className: "font-mechano text-xl md:text-2xl text-flash/80 text-center uppercase tracking-wide", children: message }), _jsx("p", { className: "font-mono text-xs text-flash/30 text-center tracking-[0.15em] max-w-md", children: subtitle }), _jsx("div", { className: "w-48 h-px", style: {
                                    background: "linear-gradient(90deg, transparent, rgba(0,217,146,0.4), transparent)",
                                } }), _jsxs("button", { onClick: () => navigate("/"), className: "group relative mt-4 cursor-clicker", children: [_jsx("span", { className: cn("block w-11 h-11 rotate-45 rounded-[3px] border transition-all duration-300", "bg-filmdark/40 border-jade/30", "group-hover:border-jade/70 group-hover:bg-jade/10", "group-hover:shadow-[0_0_20px_rgba(0,217,146,0.3)]", "shadow-[0_0_8px_rgba(0,217,146,0.1)]") }), _jsx("span", { className: "absolute inset-0 flex items-center justify-center", children: _jsx("svg", { viewBox: "0 0 10 10", className: "w-4 h-4 text-jade transition-transform duration-300 group-hover:-translate-y-[2px]", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: _jsx("polyline", { points: "1,7 5,3 9,7" }) }) }), _jsx("span", { className: "absolute -bottom-7 left-1/2 -translate-x-1/2 font-mono text-[8px] tracking-[0.3em] text-jade/30 uppercase whitespace-nowrap group-hover:text-jade/60 transition-colors", children: "Go Home" })] })] })] }), _jsx("style", { children: `
        :root {
          --orbit-scale: 0.7;
        }
