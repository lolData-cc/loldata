...
function ChampionTable({ champs, matchups, loading, }) {
    ...
    if (loading) {
        return (_jsx("div", { className: "space-y-3 py-4", children: Array.from({ length: 8 }).map((_, i) => (_jsx("div", { className: "h-10 rounded bg-filmlight/5 animate-pulse" }, i))) }));
    }
    if (champs.length === 0) {
...
function MatchupPanel({ champion, matchups }) {
    if (matchups.length === 0) {
        return (_jsxs("div", { className: "bg-filmlight/[0.015] border-t border-hairline/[0.03] px-6 py-4", children: [_jsxs("div", { className: "text-[10px] tracking-[0.15em] uppercase text-flash/20 mb-2", children: ["Most faced opponents as ", champion] }), _jsx("div", { className: "text-[11px] text-flash/15 font-jetbrains tracking-wider uppercase py-2", children: "No matchup data yet" })] }));
    }
    return (_jsxs("div", { className: "bg-filmlight/[0.015] border-t border-hairline/[0.03] px-6 py-4", children: [_jsxs("div", { className: "text-[10px] tracking-[0.15em] uppercase text-flash/20 mb-3", children: ["Most faced opponents as ", champion] }), _jsx("div", { className: "flex flex-col gap-2", children: matchups.map((m) => {
