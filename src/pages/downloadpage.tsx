        ...
        {RUNE_PAGES.map((p, i) => {
          ...
          return (
            ...
            >
              ...
              <span
                className={cn(
                  // ⚠️ Smaller on a phone. The tiles are a fifth of the column
                  // whatever the column is, and at 390px that is 64px — where
                  // "electrocute" at the app's own 8.5px runs past its own tile.
                  // The app never has this problem: its panel is a fixed 560px.
                  "block text-center font-jetbrains uppercase leading-[1.35]",
                  "text-[7px] tracking-[0.05em] sm:text-[8.5px] sm:tracking-[0.12em]",
