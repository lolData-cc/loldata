...
const FluidInput = ({ size = "md", className, ...props }) => {
    ...
    return (_jsxs("div", { className: "relative group", children: [_jsx("div", { "aria-hidden": true, className: "absolute inset-0 rounded-[3px] pointer-events-none opacity-0 group-focus-within:opacity-100 transition-opacity duration-300", style: {
                ...
                } }), _jsx("input", { ...props, className: cn("relative w-full bg-filmdark/30 border border-flash/15 rounded-[3px] font-chakrapetch text-flash placeholder:text-flash/35 outline-none", "transition-[border-color,background-color] duration-200", "group-focus-within:border-jade/0 group-hover:border-flash/25", "group-focus-within:bg-filmdark/40", sizing, className) })] }));
};
...
function PlayerCard({ index, player, onChange, onRemove, }) {
    ...
    return (_jsxs("div", { className: "relative rounded-[2px] overflow-hidden bg-filmdark/20 border border-flash/15", style: {
...
function LinkRow({ label, value, copied, onCopy, emphasis, }) {
    ...
    return (_jsxs("div", { className: "flex flex-col gap-1.5", children: [_jsxs("span", { className: "text-[11px] font-jetbrains tracking-[0.18em] uppercase flex items-center gap-1.5", style: { color: `color-mix(in srgb, ${accent} 75%, transparent)` }, children: [_jsx("span", { style: { fontSize: "9px" }, children: "\u25C6" }), " ", label] }), _jsxs("div", { className: "flex items-center gap-2 bg-filmdark/30 border border-flash/15 rounded-[3px] px-3 py-2.5 hover:border-flash/25 transition-colors", children: [_jsx("code", { className: "flex-1 text-[13px] font-jetbrains text-flash/90 truncate", children: value }), _jsx("button", { type: "button", onClick: onCopy, className: cn("text-[11px] font-jetbrains tracking-[0.18em] uppercase px-3 py-1.5 rounded-[3px] border cursor-clicker", "flex items-center gap-1.5 transition-all duration-200", copied
...
export default function ScoutCreateLobbyPage() {
    ...
    return (_jsxs("div", { className: "relative w-full font-geist", children: [_jsxs(motion.div, { "aria-hidden": true, className: "fixed inset-0 -z-10 overflow-hidden", initial: prefersReduced ? false : { opacity: 0 }, animate: { opacity: 1 }, transition: { duration: 1.1, ease: EASE_BRAND }, children: [_jsx(motion.img, { src: BRAUM_SPLASH, alt: "", className: "absolute inset-0 h-full w-full select-none object-cover object-[center_20%]", initial: prefersReduced ? false : { scale: 1.08 }, animate: { scale: 1 }, transition: { duration: 1.6, ease: EASE_BRAND } }), _jsx("div", { className: "absolute inset-0 bg-[#040A0C]/78" }), _jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-[#040A0C] via-[#040A0C]/55 to-transparent" }), _jsx("div", { className: "absolute inset-x-0 bottom-0 h-[45%] bg-gradient-to-t from-[#040A0C] to-transparent" }), _jsx("div", { className: "absolute inset-x-0 top-0 h-28 bg-gradient-to-b from-[#040A0C] via-[#040A0C]/70 to-transparent" }), _jsx("div", { className: "pointer-events-none absolute left-[8%] top-[16%] h-[360px] w-[520px] rounded-full bg-jade/10 blur-[120px]" })] }), _jsxs("div", { className: "relative z-10 mx-auto min-h-screen w-full max-w-[880px] pt-10 pb-28", children: [_jsxs("div", { className: "mb-9", children: [_jsxs(motion.div, { className: "mb-3 flex items-center gap-2.5", ...rise(0.12), children: [_jsx("span", { style: { color: JADE, fontSize: "12px" }, children: "\u25C8" }), _jsx("span", { className: "font-jetbrains text-[12px] font-medium uppercase tracking-[0.32em] text-jade/80", children: "Scout \u00B7 New lobby" })] }), _jsxs(motion.h1, { className: "font-chakrapetch text-4xl font-bold uppercase leading-[0.95] tracking-[0.02em] text-flash drop-shadow-[0_4px_24px_rgba(var(--c-shadow),0.9)] sm:text-[52px]", ...rise(0.22), children: ["Assemble", _jsx("br", {}), "the squad"] }), _jsx(motion.p, { className: "mt-4 max-w-[52ch] font-chakrapetch text-[14px] leading-relaxed text-flash/70 drop-shadow-[0_2px_12px_rgba(var(--c-shadow),0.9)]", ...rise(0.36), children: "Drop in a roster of Riot accounts and Scout tracks them as one \u2014 every match, LP swing and duo, refreshed live." })] }), _jsxs(motion.div, { className: glassDark, ...rise(0.46, 22), children: [_jsx(GlowBackdrop, {}), _jsx(BorderBeam, { duration: 10, size: 120 }), _jsxs("button", { type: "button", onClick: () => setShowTutorial(true), className: "group absolute right-4 top-4 z-20 inline-flex items-center gap-1.5 rounded-md bg-filmdark/40 px-3 py-2 font-chakrapetch text-[11px] font-bold uppercase tracking-[0.16em] text-flash/70 backdrop-blur-sm shadow-[inset_0_0_0_0.5px_rgba(255,255,255,0.12)] transition-[color,box-shadow] hover:text-flash hover:shadow-[inset_0_0_0_0.5px_rgba(255,255,255,0.22)] cursor-clicker", children: [_jsx(HelpCircle, { className: "h-3.5 w-3.5" }), " What is this?"] }), _jsxs("div", { className: "relative z-10 px-6 pb-6 pt-14 sm:px-8 sm:pb-8", children: [_jsx(FieldLabel, { children: "Lobby name" }), _jsx(FluidInput, { value: lobbyName, onChange: (e) => setLobbyName(e.target.value), placeholder: "e.g. Friday Night Crew", maxLength: 80, size: "lg" }), _jsxs("div", { className: "mt-8", children: [_jsx(SectionHeader, { label: "Players", meta: `${players.length}/${MAX_PLAYERS} · ${totalAccounts} accounts`, right: _jsx(FluidButton, { onClick: addPlayer, disabled: players.length >= MAX_PLAYERS, variant: "secondary", size: "sm", icon: _jsx(Plus, { className: "w-3.5 h-3.5" }), children: "Add Player" }) }), _jsx("div", { className: "mt-4 flex flex-col gap-3", children: players.map((p, i) => (_jsx(PlayerCard, { index: i, player: p, onChange: (next) => updatePlayer(p.uid, next), onRemove: () => removePlayer(p.uid) }, p.uid))) })] }), _jsxs("div", { className: "mt-8 flex flex-col gap-3", children: [submitError && (_jsxs("span", { className: "text-[11px] font-jetbrains tracking-[0.15em] uppercase text-error/80 flex items-center gap-1.5", children: [_jsx("span", { style: { fontSize: "9px" }, children: "\u25C6" }), " ", submitError] })), _jsx("div", { className: "flex justify-end", children: _jsx(FluidButton, { onClick: submit, disabled: !canSubmit || submitting, variant: "primary", size: "lg", icon: submitting ? (_jsx(Loader2, { className: "w-4 h-4 animate-spin" })) : (_jsx("span", { style: { fontSize: "10px" }, children: "\u25C8" })), children: submitting ? "Creating" : "Create lobby" }) })] })] })] })] }), createResult && (_jsx(CreatedDialog, { result: createResult, onClose: () => {
                ...
                }, onOpenLobby: () => navigate(`/scout/${createResult.slug}`) })), _jsx(ScoutTutorial, { open: showTutorial, onClose: () => setShowTutorial(false), onDive: () => setShowTutorial(false) })] }));
}
