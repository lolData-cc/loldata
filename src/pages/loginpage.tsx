  ...
  const loginWithDiscord = useCallback(async () => {
    ...
    const { error } = await supabase.auth.signInWithOAuth({
      ...
      options: {
        ...
        redirectTo, // deve combaciare con i Redirects su Discord (POST-redirect verso la tua SPA)
      },
    });
    if (error) {
    ...
    // Niente navigate: ci pensa il redirect di Supabase
  }, [discordLoading]);
    ...
    <div className="relative w-screen h-screen overflow-hidden">
      ...
      <div className="relative font-jetbrains text-flash/60">
        <div className="relative left-[350px] xl:bottom-[1757px] w-[500px] h-[600px]">
          ...
          >
            <div className="relative w-full h-[600px] bg-[radial-gradient(ellipse_at_top_left,_rgba(50,50,50,1),_rgba(14,14,14,0.02))] backdrop-blur-[5px] border border-flash/25 rounded-sm shadow-lg ring-1 ring-white/5 p-8 overflow-hidden">
  ...
  blur-3xl"
              ...
              <div className="flex justify-between">
                ...
                <div
                  ...
                  className={cn(
                    "bg-transparent w-[30%] h-12 rounded-[4px] border border-flash/10 flex items-center justify-center group cursor-clicker hover:bg-flash/10",
                ...
                >
                  <svg
                    ...
                    className={cn(
                      ...
                      discordLoading ? "fill-[#5865F2]" : "fill-gray-500 group-hover:fill-[#5865F2]"
                    )}
                  >
                ...
                <div className="bg-transparent w-[30%] h-12 rounded-[4px] border border-flash/10 flex items-center justify-center group cursor-clicker hover:bg-flash/10">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" className="w-7 h-7 transition-colors duration-200">
                    <circle cx="24" cy="24" r="20" className="fill-gray-500 group-hover:fill-[#d32f2f] transition-colors duration-200" />
                    <polygon
                      ...
                      className="fill-gray-200 group-hover:fill-white transition-colors duration-200"
                    />
                    <polygon
                ...
                <div className="bg-transparent w-[30%] h-12 rounded-[4px] border border-flash/10 flex items-center justify-center group cursor-clicker hover:bg-flash/10">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" className="w-7 h-7 transition-colors duration-200">
                    <path d="M43.611,20.083H42V20H24v8h11.303c-1.649,4.657-6.08,8-11.303,8c-6.627,0-12-5.373-12-12 s5.373-12,12-12c3.059,0,5.842,1.154,7.961,3.039l5.657-5.657C34.046,6.053,29.268,4,24,4C12.955,4,4,12.955,4,24s8.955,20,20,20 s20-8.955,20-20C44,22.659,43.862,21.35,43.611,20.083z" className="fill-gray-500 group-hover:fill-[#fbc02d] transition-colors duration-200" />
                    <path d="M6.306,14.691l6.571,4.819C14.655,15.108,18.961,12,24,12c3.059,0,5.842,1.154,7.961,3.039 l5.657-5.657C34.046,6.053,29.268,4,24,4C16.318,4,9.656,8.337,6.306,14.691z" className="fill-gray-500 group-hover:fill-[#e53935] transition-colors duration-200" />
                    <path d="M24,44c5.166,0,9.86-1.977,13.409-5.192l-6.19-5.238C29.211,35.091,26.715,36,24,36 c-5.202,0-9.619-3.317-11.283-7.946l-6.522,5.025C9.505,39.556,16.227,44,24,44z" className="fill-gray-500 group-hover:fill-[#4caf50] transition-colors duration-200" />
                    <path d="M43.611,20.083L43.595,20L42,20H24v8h11.303c-0.792,2.237-2.231,4.166-4.087,5.571 c0.001-0.001,0.002-0.001,0.003-0.002l6.19,5.238C36.971,39.205,44,34,44,24C44,22.659,43.862,21.35,43.611,20.083z" className="fill-gray-500 group-hover:fill-[#1565c0] transition-colors duration-200" />
                  </svg>
                </div>
              </div>
