...
/* ─── shared styles ──────────────────────────────────────────────────── */
const glassDark = cn("relative overflow-hidden rounded-md", "bg-filmdark/15 backdrop-blur-lg saturate-150 glass-panel", "shadow-[0_10px_30px_rgba(var(--c-shadow),0.55),inset_0_0_0_0.5px_rgba(255,255,255,0.08),inset_0_1px_0_rgba(255,255,255,0.04)]");
...
function SectionAvatars({ members, activePlayerId, accent, onSelect, }) {
    ...
    return (_jsxs("div", { className: "flex items-center gap-1.5 shrink-0", children: [visible.map((m) => {
            ...
            }), unique.length > 4 && (_jsx("div", { className: "w-9 h-9 rounded-full flex items-center justify-center bg-filmdark/40 border border-flash/15", children: _jsxs("span", { className: "text-[11px] font-jetbrains font-bold text-flash/60", children: ["+", unique.length - 4] }) }))] }));
}
...
function PlayerSectionCardImpl({ members, matches, itemsByMatch, squadMatchIds, lobbyAccountByPuuid, lobbySlug, social, canLike, canComment, }) {
    ...
    return (_jsxs("div", { className: "relative overflow-hidden rounded-md bg-flash/[0.013] backdrop-blur-xl saturate-150 ring-1 ring-flash/[0.08] shadow-[0_18px_44px_-12px_rgba(var(--c-shadow),0.8),0_4px_14px_rgba(var(--c-shadow),0.45),inset_0_1px_0_rgba(255,255,255,0.045)]", children: [_jsx("div", { "aria-hidden": true, className: "absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-flash/25 to-transparent pointer-events-none z-[1]" }), _jsx("div", { className: "absolute left-0 top-0 bottom-0 w-[3px] z-[1]", style: {
...
function LiveSessionCard({ group, championIdToName, now, }) {
    ...
    for (const p of group.participants)
        teamByPuuid.set(p.puuid, p.teamId);
    const count = group.members.length;
    const stackLabel = count === 2 ? "DUO" : count === 3 ? "TRIO" : `${count}-STACK`;
    // Uniform tiles that wrap, so a 5-stack reads as a tidy 3+2 grid instead
    // of a lopsided 5-tall column.
    const memberCols = count === 1
        ? "grid-cols-1"
        : count === 2
            ? "grid-cols-2"
            : "grid-cols-2 sm:grid-cols-3";
    const hasBans = group.bansBlue.length > 0 || group.bansRed.length > 0;
    return (_jsxs("div", { className: "group/live relative overflow-hidden rounded-lg bg-filmdark/30 backdrop-blur-lg saturate-150 glass-panel ring-1 ring-hairline/[0.06] shadow-[0_10px_30px_rgba(var(--c-shadow),0.5)] transition-shadow hover:shadow-[0_16px_44px_rgba(var(--c-shadow),0.62)]", children: [_jsxs("div", { className: "absolute inset-0 z-0", children: [_jsx("img", { src: splash, alt: "", className: "absolute inset-0 w-full h-full object-cover opacity-[0.16]", style: { objectPosition: "center 22%" } }), _jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-liquirice/80 via-liquirice/92 to-liquirice/97" }), _jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-liquirice/70 via-transparent to-transparent" })] }), _jsx("div", { className: "absolute top-0 inset-x-0 h-[2px] z-[1]", style: {
                    background: `linear-gradient(to right, ${accent}, color-mix(in srgb, ${accent} 20%, transparent) 55%, transparent)`,
                } }), _jsxs("div", { className: "relative z-[2] flex items-center gap-2.5 flex-wrap px-3.5 pt-3 pb-2.5", children: [_jsxs("span", { className: "inline-flex items-center gap-1.5", children: [_jsxs("span", { className: "relative inline-flex", children: [_jsx("span", { className: "absolute inset-0 rounded-full bg-jade/40 animate-ping", style: { animationDuration: "1.6s" } }), _jsx("span", { className: "relative inline-flex w-1.5 h-1.5 rounded-full bg-jade" })] }), _jsx("span", { className: "text-[10px] font-jetbrains tracking-[0.28em] uppercase text-jade font-bold", children: "LIVE" })] }), _jsx("span", { className: "text-flash/20 text-[10px]", children: "\u00B7" }), _jsx("span", { className: "text-[10px] font-jetbrains tracking-[0.2em] uppercase text-flash/55", children: queueLabel }), _jsx("span", { className: "text-flash/20 text-[10px]", children: "\u00B7" }), _jsxs("span", { className: "text-[11px] font-chakrapetch font-semibold text-flash/75 tabular-nums tracking-wide", children: [mins, ":", secs] }), _jsx("span", { className: "flex-1" }), isMulti && (_jsx("span", { className: "inline-flex items-center px-2 py-[3px] rounded-[3px] text-[9px] font-jetbrains tracking-[0.2em] uppercase font-bold leading-none", style: {
                            color: accent,
                            background: `color-mix(in srgb, ${accent} 13%, transparent)`,
                            boxShadow: `inset 0 0 0 1px color-mix(in srgb, ${accent} 32%, transparent)`,
                        }, children: stackLabel })), _jsxs(Link, { to: liveGameHref, className: "inline-flex items-center gap-1.5 px-2.5 py-1 rounded-[3px] border border-jade/35 bg-jade/[0.08] text-jade hover:bg-jade/[0.2] hover:shadow-[0_0_12px_rgba(0,217,146,0.25)] text-[9.5px] font-jetbrains tracking-[0.2em] uppercase font-bold cursor-clicker transition-all", children: [_jsx(Eye, { className: "w-3 h-3" }), "Spectate", _jsx("span", { className: "text-jade/45 text-[8px] ml-0.5", children: lead.region })] })] }), _jsx("div", { className: "relative z-[2] px-3.5 pb-3", children: _jsx("div", { className: cn("grid gap-2", memberCols), children: group.members.map((m) => (_jsx(MemberTile, { member: m, teamId: teamByPuuid.get(m.accountPuuid) ?? null, championName: championIdToName[String(m.championId)] ?? String(m.championId), solo: count === 1 }, m.playerId))) }) }), _jsxs("div", { className: "relative z-[2] border-t border-hairline/[0.06] px-3.5 py-3", children: [_jsxs("div", { className: "grid grid-cols-[1fr_auto_1fr] gap-3 items-stretch text-[10.5px] font-jetbrains", children: [_jsx(TeamRoster, { participants: blue, accent: "#5fa8ff", teamLabel: "BLUE", championIdToName: championIdToName, activePuuids: activePuuids, align: "left" }), _jsxs("div", { className: "flex flex-col items-center gap-1", children: [_jsx("span", { className: "flex-1 w-px bg-gradient-to-b from-transparent to-flash/12" }), _jsx("span", { className: "text-[8px] font-jetbrains tracking-[0.18em] text-flash/35 font-bold", children: "VS" }), _jsx("span", { className: "flex-1 w-px bg-gradient-to-t from-transparent to-flash/12" })] }), _jsx(TeamRoster, { participants: red, accent: "#ef4444", teamLabel: "RED", championIdToName: championIdToName, activePuuids: activePuuids, align: "right" })] }), hasBans && (_jsxs("div", { className: "mt-2.5 flex items-center gap-3", children: [_jsx(BansStrip, { bans: group.bansBlue, accent: "#5fa8ff", championIdToName: championIdToName, align: "left" }), _jsx("div", { className: "flex-1 h-px bg-gradient-to-r from-flash/10 via-flash/16 to-flash/10" }), _jsx(BansStrip, { bans: group.bansRed, accent: "#ef4444", championIdToName: championIdToName, align: "right" })] }))] })] }));
}
...
function MemberTile({ member, championName, teamId, solo, }) {
    const accent = member.color || JADE;
    const teamColor = teamId === 100 ? "#5fa8ff" : teamId === 200 ? "#ef4444" : accent;
    const champIcon = `${cdnBaseUrl()}/img/champion/${normalizeChampName(championName)}.png`;
    const summonerHref = `/summoners/${member.region.toLowerCase()}/${encodeURIComponent(member.riotName)}-${encodeURIComponent(member.riotTag)}`;
    ...
    const showRiotId = member.displayName.trim().toLowerCase() !==
        member.riotName.trim().toLowerCase();
    return (_jsxs("div", { className: "relative flex items-center gap-2.5 rounded-md pl-3 pr-2.5 py-2 bg-filmlight/[0.03] ring-1 ring-hairline/[0.06] overflow-hidden", children: [_jsx("span", { "aria-hidden": true, className: "absolute left-0 top-0 bottom-0 w-[2px]", style: { background: `color-mix(in srgb, ${teamColor} 70%, transparent)` } }), _jsxs("div", { className: "relative shrink-0", style: { width: portrait, height: portrait }, children: [_jsx("img", { src: champIcon, alt: championName, className: "w-full h-full rounded-md object-cover", style: {
                            boxShadow: `inset 0 0 0 1.5px color-mix(in srgb, ${teamColor} 62%, transparent), 0 2px 8px rgba(0,0,0,0.5)`,
                        } }), _jsx("div", { className: "absolute -bottom-1 -right-1 w-[18px] h-[18px] rounded-full overflow-hidden ring-2 ring-liquirice bg-black", style: { boxShadow: `0 0 6px color-mix(in srgb, ${accent} 50%, transparent)` }, children: icon ? (_jsx("img", { src: icon, alt: "", className: "w-full h-full" })) : (_jsx("span", { className: "w-full h-full flex items-center justify-center text-[9px] font-jetbrains font-bold", style: { color: accent, background: "rgba(0,0,0,0.6)" }, children: member.displayName.slice(0, 1).toUpperCase() })) })] }), _jsxs("div", { className: "flex flex-col min-w-0 gap-[3px]", children: [_jsx(Link, { to: summonerHref, className: "font-chakrapetch font-bold leading-none truncate hover:text-jade transition-colors cursor-clicker", style: { color: accent, fontSize: solo ? 15 : 13 }, children: member.displayName }), _jsxs("span", { className: "inline-flex items-center gap-1.5 min-w-0", children: [_jsx("span", { className: "font-chakrapetch font-semibold text-jade/85 truncate leading-none", style: { fontSize: solo ? 13 : 11.5 }, children: championName }), _jsx("span", { "aria-hidden": true, className: "w-1 h-1 rounded-full shrink-0", style: { background: teamColor, boxShadow: `0 0 5px ${teamColor}` } })] }), showRiotId && (_jsxs("span", { className: "text-flash/35 font-medium leading-none truncate", style: { fontSize: solo ? 10 : 9 }, children: [member.riotName, _jsxs("span", { className: "text-flash/25", children: ["#", member.riotTag] })] }))] })] }));
}
...
function LeaderboardStatBox({ icon, label, player, highlightFn, highlightLabel, emptyText, loading, }) {
    return (_jsxs("div", { className: "relative overflow-hidden rounded-md bg-filmdark/18 backdrop-blur-lg saturate-150 glass-panel shadow-[0_8px_24px_rgba(var(--c-shadow),0.45),inset_0_0_0_0.5px_rgba(255,255,255,0.06),inset_0_1px_0_rgba(255,255,255,0.03)]", children: [_jsx(GlowBackdrop, { subtle: true }), _jsxs("div", { className: "relative z-[1] p-4", children: [_jsxs("div", { className: "flex items-center gap-2 mb-3", children: [_jsx("span", { className: "text-jade", children: icon }), _jsx("span", { className: "text-[10px] font-jetbrains tracking-[0.22em] uppercase text-flash/55 font-medium", children: label }), _jsx("div", { className: "flex-1 h-[1px] bg-gradient-to-r from-flash/10 to-transparent" })] }), loading ? (_jsx("div", { className: "h-[58px] flex items-center justify-center", children: _jsx(Loader2, { className: "w-4 h-4 animate-spin text-jade/60" }) })) : player ? (_jsxs("div", { className: "flex items-center gap-3", children: [profileIconUrl(player.iconId) ? (_jsx("img", { src: profileIconUrl(player.iconId), alt: "", className: "w-11 h-11 rounded-full shrink-0", style: {
...
function BountyLeaderboardPanel({ slug, refreshTick, }) {
    ...
    return (_jsxs("div", { className: cn(glassDark, "p-5 md:p-6"), children: [_jsx(GlowBackdrop, { subtle: true }), _jsxs("div", { className: "relative z-[1]", children: [_jsxs("div", { className: "flex items-center gap-3 mb-5", children: [_jsx("span", { className: "text-jade", children: _jsx(Target, { className: "w-4 h-4" }) }), _jsx("span", { className: "text-[11px] font-jetbrains tracking-[0.25em] uppercase text-flash/70 font-medium", children: "Bounty Leaderboard" }), _jsx("div", { className: "flex-1 h-[1px] bg-gradient-to-r from-flash/15 to-transparent" }), _jsx("span", { className: "text-[9px] font-jetbrains tracking-[0.25em] uppercase text-flash/35", children: "ALL-TIME" })] }), loading ? (_jsx("div", { className: "py-10 flex items-center justify-center", children: _jsx(Loader2, { className: "w-4 h-4 animate-spin text-jade/60" }) })) : rows.length === 0 ? (_jsxs("div", { className: "py-10 text-center", children: [_jsx("div", { className: "text-[12px] font-jetbrains tracking-[0.2em] uppercase text-flash/35", children: "No bounties claimed yet" }), _jsx("div", { className: "text-[10px] font-jetbrains tracking-[0.1em] text-flash/25 mt-2", children: "Be the first to claim today's challenge" })] })) : (_jsx("div", { className: "flex flex-col gap-2", children: rows.map((row, idx) => {
                            ...
                            return (_jsxs("div", { className: "relative flex items-center gap-3 px-3 py-2.5 rounded-md bg-filmdark/15 border border-flash/[0.05] hover:bg-filmdark/25 transition-colors", children: [_jsx("div", { className: "w-7 h-7 rounded-full flex items-center justify-center shrink-0 text-[11px] font-jetbrains font-bold tabular-nums", style: {
                                            background: medal
                                            ...
                                            : verifyMode === "claim_only"
                                                ...
                                                : "border-flash/10 bg-filmdark/15 hover:border-flash/25"), children: [_jsx(Lock, { className: cn("w-4 h-4 mt-0.5 shrink-0", isPrivate ? "text-jade" : "text-flash/45") }), _jsxs("div", { className: "flex flex-col min-w-0 flex-1", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx("span", { className: cn("text-[11px] font-chakrapetch font-bold", isPrivate ? "text-flash" : "text-flash/70"), children: "Private lobby" }), _jsx("span", { className: cn("relative ml-auto w-8 h-4 rounded-full transition-colors shrink-0", isPrivate
                                                                        ...
                                                                        : "bg-flash/10 border border-flash/15"), children: _jsx("span", { className: cn("absolute top-[1px] w-[14px] h-[14px] rounded-full transition-all", isPrivate
                                                                            ...
                                                                            : "left-[1px] bg-flash/40") }) })] }), _jsx("span", { className: "text-[9px] text-flash/45 font-chakrapetch mt-0.5 leading-snug", children: "Only claimed members + admins can view the lobby. Everyone else sees a locked page." })] })] }), _jsx("div", { className: "text-[9px] font-jetbrains tracking-[0.22em] uppercase text-flash/40 mb-1.5", children: "Verification mode" }), _jsx(VerifyModeRadio, { value: verifyMode, onChange: setVerifyMode })] }), _jsx(EditCollapsible, { open: openSections.has("webhooks"), onToggle: () => toggleSection("webhooks"), title: "Discord", summary: "Mirror the feed to a channel", children: _jsx(LobbyWebhooksPanel, { lobbySlug: lobby.slug, open: openSections.has("webhooks") }) }), err && (_jsxs("div", { className: "text-[11px] font-jetbrains tracking-[0.15em] uppercase text-error/80 mb-3", children: ["\u25C6 ", err] })), _jsxs("div", { className: "flex items-center justify-between gap-2", children: [_jsxs("button", { onClick: () => {
                                                if (confirmArmed)
                                                    deleteLobby();
                                                else
...
function EditPlayerRow({ index, player, onChange, onRemove, seamless = false, }) {
    ...
    return (_jsxs("div", { className: cn("p-3", seamless
            ? "bg-transparent"
            : "bg-filmdark/25 border border-flash/15 rounded-[3px]"), children: [_jsxs("div", { className: "flex items-center gap-2 mb-2", children: [_jsx("span", { className: "text-[10px] font-jetbrains font-medium tracking-[0.2em] uppercase px-1.5 py-[2px] rounded-[2px]", style: {
                            color: "#00d992",
                            background: "rgba(0,217,146,0.08)",
                            border: "1px solid color-mix(in srgb, #00d992 25%, transparent)",
                        }, children: slotLabel }), _jsx("input", { value: player.displayName, onChange: (e) => onChange({ ...player, displayName: e.target.value }), placeholder: "Player name", maxLength: 40, className: "flex-1 bg-transparent text-sm text-flash placeholder:text-flash/30 outline-none border-b border-flash/0 focus:border-jade/40 transition-colors py-0.5 font-chakrapetch" }), _jsx("button", { onClick: onRemove, className: "text-flash/35 hover:text-error transition-colors cursor-clicker", children: _jsx(X, { className: "w-4 h-4" }) })] }), _jsxs("div", { className: "flex flex-col gap-1 pl-1", children: [player.accounts.map((a) => (_jsxs("div", { className: "flex items-center gap-2 text-xs px-1 py-1 rounded-[2px] hover:bg-flash/[0.03]", children: [_jsx(Check, { className: "w-3 h-3 text-jade shrink-0" }), _jsx("span", { className: "text-[10px] font-jetbrains tracking-[0.15em] uppercase text-jade/60 w-9", children: a.region }), _jsxs("span", { className: "text-flash/80 truncate", children: [a.riotName, _jsxs("span", { className: "text-flash/30", children: ["#", a.riotTag] })] }), _jsx("button", { onClick: () => onChange({
                                    ...player,
                                    accounts: player.accounts.filter((x) => x.uid !== a.uid),
                                }), className: "ml-auto text-flash/30 hover:text-error cursor-clicker", children: _jsx(X, { className: "w-3.5 h-3.5" }) })] }, a.uid))), adding ? (_jsxs("div", { className: "flex flex-col gap-1.5 mt-1", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx("select", { value: region, onChange: (e) => setRegion(e.target.value), className: "bg-filmdark/40 border border-flash/15 rounded-[2px] text-[10px] font-jetbrains tracking-[0.15em] uppercase text-flash/85 px-2 py-1 outline-none", children: REGIONS.map((r) => (_jsx("option", { value: r, children: r }, r))) }), _jsx("input", { autoFocus: true, value: raw, onChange: (e) => setRaw(e.target.value), onKeyDown: (e) => {
                                            if (e.key === "Enter")
                                                submitAccount();
                                            if (e.key === "Escape")
                                                setAdding(false);
                                        }, placeholder: "name#tag", className: "flex-1 bg-filmdark/30 border border-flash/15 rounded-[2px] text-xs text-flash placeholder:text-flash/30 px-2 py-1 outline-none focus:border-jade/40 font-chakrapetch" }), _jsx("button", { onClick: submitAccount, disabled: verifying, className: "text-[10px] font-jetbrains tracking-[0.15em] uppercase px-2 py-1 rounded-[2px] border border-jade/40 text-jade bg-jade/10 hover:bg-jade/20 cursor-clicker", children: verifying ? "…" : "Add" }), _jsx("button", { onClick: () => {
                                            setAdding(false);
                                            setRaw("");
                                            setAccErr(null);
...
function PlayerIdentityPanel({ lobbySlug, playerId, persisted, displayName, onChanged, }) {
    ...
    if (!playerId || !persisted) {
        return (_jsx("div", { className: "px-3 py-2 bg-filmdark/15", children: _jsx("span", { className: "text-[9px] font-jetbrains tracking-[0.18em] uppercase text-flash/30", children: "Save to enable identity controls" }) }));
    }
 ...
 * PATCH per keystroke.
 */
function WebhookIdentityEditor({ hook, busy, onSave, }) {
    ...
    return (_jsxs("div", { className: "mt-2 pt-2 border-t border-flash/[0.06]", children: [_jsx("div", { className: "text-[9px] font-jetbrains tracking-[0.22em] uppercase text-flash/40 mb-1.5", children: "Posts as" }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsx("div", { className: "w-9 h-9 shrink-0 rounded-full overflow-hidden bg-black/40 border border-flash/10 grid place-items-center", children: avatar && !broken ? (_jsx("img", { src: avatar, alt: "", className: "w-full h-full object-cover", onError: () => setBroken(true) })) : (_jsx(Webhook, { className: "w-4 h-4 text-flash/25" })) }), _jsx("input", { value: name, onChange: (e) => setName(e.target.value), placeholder: "Bot name", maxLength: 80, className: "min-w-0 flex-1 bg-black/25 border border-flash/15 rounded-[3px] h-8 px-2 text-[11px] font-chakrapetch text-flash placeholder:text-flash/25 outline-none focus:border-jade/45 transition-colors" })] }), _jsxs("div", { className: "flex items-center gap-2 mt-1.5", children: [_jsx("input", { value: avatar, onChange: (e) => setAvatar(e.target.value), placeholder: "Avatar image URL (png/jpg)", spellCheck: false, className: "min-w-0 flex-1 bg-black/25 border border-flash/15 rounded-[3px] h-8 px-2 text-[10px] font-jetbrains text-flash placeholder:text-flash/25 outline-none focus:border-jade/45 transition-colors" }), _jsx("button", { type: "button", onClick: () => onSave({ username: name, avatarUrl: avatar }), disabled: busy || !dirty, className: cn("shrink-0 text-[9px] font-jetbrains tracking-[0.18em] uppercase font-medium px-2.5 h-8 rounded-[3px] border cursor-clicker transition-all", dirty && !busy
                            ? "border-jade/45 text-jade bg-jade/[0.10] hover:bg-jade/[0.20]"
                            : "border-flash/10 text-flash/25"), children: "Save" })] }), broken && avatar && (_jsx("div", { className: "text-[9px] font-jetbrains tracking-[0.1em] text-error/70 mt-1", children: "\u25C6 That URL isn't loading as an image" })), _jsx("div", { className: "text-[9px] font-chakrapetch text-flash/35 mt-1.5 leading-snug", children: "Leave both empty to use the name and picture set on the webhook in Discord \u2014 that way you can upload an image instead of hosting one." })] }));
}
/**
 ...
 */
function LobbyWebhooksPanel({ lobbySlug, open, }) {
    ...
    const patch = async (id, body) => {
        ...
        try {
            ...
            if (!headers)
                return;
            const res = await fetch(`${API_BASE_URL}/api/scout/webhooks/${lobbySlug}/${id}`, { method: "PATCH", headers, body: JSON.stringify(body) });
            const data = await res.json().catch(() => ({}));
            if (!res.ok) {
    ...
    const remove = async (id) => {
        ...
        try {
            ...
            if (!headers)
                return;
            const res = await fetch(`${API_BASE_URL}/api/scout/webhooks/${lobbySlug}/${id}`, { method: "DELETE", headers });
            if (!res.ok) {
    ...
    const sendTest = async (id) => {
        ...
        try {
            ...
            if (!headers)
                return;
            const res = await fetch(`${API_BASE_URL}/api/scout/webhooks/${lobbySlug}/${id}/test`, { method: "POST", headers });
            const body = await res.json().catch(() => ({}));
            if (!res.ok) {
                showCyberToast({
                    title: "Test failed",
    ...
    return (_jsxs("div", { children: [_jsxs("div", { className: "text-[10px] font-chakrapetch text-flash/45 leading-snug mb-3", children: ["Post every finished game to a Discord channel \u2014 champion, K/D/A, score and the lobby's average elo, like a mirror of the feed. In Discord:", " ", _jsx("span", { className: "text-flash/70", children: "Channel settings \u2192 Integrations \u2192 Webhooks \u2192 New webhook \u2192 Copy URL" }), "."] }), hooks === null ? (_jsxs("div", { className: "flex items-center gap-2 text-[10px] font-jetbrains tracking-[0.18em] uppercase text-flash/35 py-2", children: [_jsx(Loader2, { className: "w-3 h-3 animate-spin" }), " Loading"] })) : hooks.length === 0 ? (_jsx("div", { className: "text-[10px] font-jetbrains tracking-[0.15em] uppercase text-flash/30 mb-3", children: "No channel connected" })) : (_jsx("div", { className: "flex flex-col gap-2 mb-3", children: hooks.map((h) => (_jsxs("div", { className: "rounded-[3px] border border-flash/[0.08] bg-black/[0.18] p-2.5", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx(Webhook, { className: cn("w-3.5 h-3.5 shrink-0", h.enabled ? "text-jade" : "text-flash/30") }), _jsxs("div", { className: "min-w-0 flex-1", children: [_jsx("div", { className: "text-[11px] font-chakrapetch font-bold text-flash truncate", children: h.label || "Discord channel" }), _jsx("div", { className: "text-[9px] font-jetbrains text-flash/35 truncate", children: h.target })] }), _jsx("button", { type: "button", onClick: () => patch(h.id, { enabled: !h.enabled }), disabled: busy === h.id, title: h.enabled ? "Pause posting" : "Resume posting", className: cn("relative w-8 h-4 rounded-full transition-colors shrink-0 cursor-clicker disabled:opacity-40", h.enabled
                                        ? "bg-jade/40 border border-jade/60"
                                        : "bg-flash/10 border border-flash/15"), children: _jsx("span", { className: cn("absolute top-[1px] w-[14px] h-[14px] rounded-full transition-all", h.enabled
                                            ? "left-[15px] bg-jade shadow-[0_0_6px_rgba(0,217,146,0.6)]"
                                            : "left-[1px] bg-flash/40") }) })] }), _jsxs("div", { className: "flex items-center gap-1.5 mt-2 flex-wrap", children: [QUEUE_PRESETS.map((p) => {
                                    const active = presetKeyFor(h.queueFilter) === p.key;
                                    return (_jsx("button", { type: "button", onClick: () => patch(h.id, { queueFilter: p.ids }), disabled: busy === h.id, className: cn("text-[9px] font-jetbrains tracking-[0.16em] uppercase px-2 py-1 rounded-[3px] border cursor-clicker transition-all disabled:opacity-40", active
                                            ? "border-jade/40 text-jade bg-jade/[0.10]"
                                            : "border-flash/10 text-flash/40 hover:text-flash/70 hover:border-flash/25"), children: p.label }, p.key));
                                }), _jsx("div", { className: "flex-1" }), _jsxs("button", { type: "button", onClick: () => sendTest(h.id), disabled: busy === h.id, className: "flex items-center gap-1.5 text-[9px] font-jetbrains tracking-[0.18em] uppercase font-medium px-2 py-1 rounded-[3px] border border-jade/25 text-jade/85 bg-jade/[0.06] hover:bg-jade/[0.15] cursor-clicker transition-all disabled:opacity-40", children: [busy === h.id ? (_jsx(Loader2, { className: "w-3 h-3 animate-spin" })) : (_jsx(Send, { className: "w-3 h-3" })), "Test"] }), _jsx("button", { type: "button", onClick: () => remove(h.id), disabled: busy === h.id, title: "Disconnect", className: "p-1 rounded-[3px] text-flash/35 hover:text-error/80 hover:bg-error/[0.06] cursor-clicker disabled:opacity-40", children: _jsx(Trash2, { className: "w-3.5 h-3.5" }) })] }), _jsx(WebhookIdentityEditor, { hook: h, busy: busy === h.id, onSave: (identity) => patch(h.id, identity) }), h.lastError && (_jsxs("div", { className: "flex items-start gap-1.5 mt-2 text-[9px] font-jetbrains tracking-[0.1em] text-error/75 leading-snug", children: [_jsx(AlertTriangle, { className: "w-3 h-3 shrink-0 mt-[1px]" }), _jsx("span", { className: "min-w-0 break-words", children: h.lastError })] }))] }, h.id))) })), loadErr && (_jsxs("div", { className: "text-[10px] font-jetbrains tracking-[0.15em] uppercase text-error/70 mb-2", children: ["\u25C6 ", loadErr] })), _jsxs("div", { className: "rounded-[3px] border border-flash/[0.08] bg-filmdark/20 p-2.5", children: [_jsx("div", { className: "text-[9px] font-jetbrains tracking-[0.22em] uppercase text-flash/40 mb-1.5", children: "Connect a channel" }), _jsx("input", { value: url, onChange: (e) => setUrl(e.target.value), placeholder: "https://discord.com/api/webhooks/\u2026", spellCheck: false, className: "w-full bg-black/25 border border-flash/15 rounded-[3px] h-9 px-2.5 text-[11px] font-jetbrains text-flash placeholder:text-flash/25 outline-none focus:border-jade/45 transition-colors" }), _jsxs("div", { className: "flex items-center gap-2 mt-2", children: [_jsx("input", { value: label, onChange: (e) => setLabel(e.target.value), placeholder: "Label (optional) \u2014 e.g. #scrims-feed", maxLength: 60, className: "flex-1 min-w-0 bg-black/25 border border-flash/15 rounded-[3px] h-9 px-2.5 text-[11px] font-chakrapetch text-flash placeholder:text-flash/25 outline-none focus:border-jade/45 transition-colors" }), _jsxs("button", { type: "button", onClick: add, disabled: adding || !url.trim(), className: "shrink-0 flex items-center gap-1.5 text-[10px] font-jetbrains tracking-[0.2em] uppercase font-medium px-3 h-9 rounded-[3px] border border-jade/45 text-jade bg-jade/[0.10] hover:bg-jade/[0.20] cursor-clicker transition-all disabled:opacity-40", children: [adding ? (_jsx(Loader2, { className: "w-3 h-3 animate-spin" })) : (_jsx(Plus, { className: "w-3 h-3" })), "Connect"] })] })] })] }));
}
...
function SectionsChooser({ enabled, onChange, }) {
    ...
    return (_jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-2", children: SECTIONS_CATALOG.map((t) => {
            ...
            return (_jsxs("button", { type: "button", onClick: () => toggle(t.key), className: cn("flex items-start gap-2.5 px-3 py-2 rounded-[3px] border cursor-clicker transition-all text-left", isOn
                    ...
                    : "border-flash/10 bg-filmdark/15 hover:border-flash/25"), children: [_jsx("div", { className: cn("w-3.5 h-3.5 rounded-[2px] border flex items-center justify-center shrink-0 mt-0.5 transition-all", isOn
                            ? "bg-jade/40 border-jade/60"
                            : "border-flash/20 bg-filmdark/30"), children: isOn && _jsx(Check, { className: "w-2.5 h-2.5 text-flash" }) }), _jsxs("div", { className: "flex flex-col min-w-0 flex-1", children: [_jsxs("div", { className: "flex items-center gap-1.5", children: [_jsx("span", { className: cn("text-[11px] font-chakrapetch font-bold", isOn ? "text-flash" : "text-flash/70"), children: t.label }), isOptIn && (_jsx("span", { className: "text-[7px] font-jetbrains tracking-[0.2em] uppercase text-citrine/80 bg-citrine/10 border border-citrine/30 px-1 py-[1px] rounded-[2px]", children: "Opt-in" }))] }), _jsx("span", { className: "text-[9px] text-flash/45 font-chakrapetch mt-0.5 leading-snug", children: t.description })] })] }, t.key));
        }) }));
}
...
export default function ScoutLobbyPage() {
    ...
    return (_jsxs("div", { className: "w-full pb-24 font-geist", children: [_jsx(LobbyHero, { lobby: lobby, refreshSlot: _jsx(RefreshClock, { lastRefreshAt: lobby.lastRefreshAt, refreshing: refreshing, onRefreshDone: handleRefreshDone, slug: slug, large: true }) }), _jsx("div", { className: "flex justify-center", children: _jsxs("div", { className: "w-full max-w-[1280px] px-4 grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-6", children: [_jsx("div", { className: "min-w-0", children: _jsxs(Tabs, { value: activeTab, onValueChange: (v) => {
                                    ...
                                    navigate(next, { replace: false });
                                                        ...
                                                        const next = v === "matches" ? `/scout/${slug}` : `/scout/${slug}/${v}`;
                                                        navigate(next, { replace: false });
                                                    }, className: "w-full appearance-none bg-black/55 backdrop-blur-md ring-1 ring-jade/30 rounded-md pl-4 pr-10 py-3.5 text-[14px] font-chakrapetch font-bold tracking-[0.18em] uppercase text-jade cursor-clicker focus:outline-none focus:ring-2 focus:ring-jade/60 shadow-[inset_0_1px_0_rgba(255,255,255,0.06),0_4px_18px_rgba(var(--c-shadow),0.4)]", children: visibleTabs.map((t) => (_jsx("option", { value: t.key, children: t.label }, t.key))) }), chatUnread > 0 &&
                                                    activeTab !== "chat" &&
