...
export default function ChampionPage() {
    ...
    return (_jsxs("main", { className: "min-h-dvh bg-neutral-950 text-white", children: [_jsxs("div", { className: "mx-auto max-w-6xl px-4 py-8", children: [_jsx("h1", { className: "mb-2 text-xl font-semibold", children: "Radial Champion Selector" }), _jsx("p", { className: "text-sm text-neutral-400", children: "Wheel con finestra di colonne per una migliore leggibilit\u00E0." }), confirmed && (_jsxs("div", { className: "mt-4 flex items-center gap-3 rounded-md border border-hairline/10 bg-neutral-900/50 p-3 text-sm text-neutral-200", children: [_jsx("img", { src: confirmed.image || "/placeholder.svg", alt: `${confirmed.label} portrait`, className: "h-10 w-10 rounded object-cover" }), _jsxs("div", { children: ["Selected: ", _jsx("span", { className: "font-medium text-white", children: confirmed.label })] })] }))] }), _jsx(RadialBottomDock, { items: items, open: open, onOpen: () => setOpen(true), onConfirm: (it) => {
                    setConfirmed(it);
                    setOpen(false);
                } })] }));
}
