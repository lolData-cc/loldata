...
const glassDark = cn("relative overflow-hidden rounded-md", "bg-filmdark/35 backdrop-blur-lg saturate-150 glass-panel", "shadow-[0_20px_60px_rgba(var(--c-shadow),0.65),inset_0_0_0_0.5px_rgba(255,255,255,0.10),inset_0_1px_0_rgba(255,255,255,0.05)]");
