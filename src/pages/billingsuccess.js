...
import { Sparkles, Brain, Sword, Rocket, Users, Crown, Star, Hash, Zap, Infinity as InfinityIcon, ArrowRight, ArrowUp, ChevronDown, } from "lucide-react";
...
const PREMIUM_PERKS = [
    ...
    },
    {
        ...
        description: "Spin up Scout lobbies for your friend groups, your team, your duo, or a rival you're keeping tabs on. Each lobby aggregates live games, recent match history, win rates, LP timelines and champion habits across every account in the group. LIVE indicators show you who's in game right now. Two concurrent lobbies let you track your own stack and a rival group side by side — double the single free slot.",
        bullets: [
...
function BackToTop() {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("span", { ref: anchorRef, "aria-hidden": true, className: "hidden" }), _jsx(AnimatePresence, { children: visible && (_jsx(motion.button, { type: "button", onClick: toTop, initial: { opacity: 0, y: 12 }, animate: { opacity: 1, y: 0 }, exit: { opacity: 0, y: 12 }, transition: { duration: 0.25, ease: EASE_BRAND }, "aria-label": "Back to top", className: "fixed bottom-6 right-6 z-50 grid place-items-center w-11 h-11 rounded-full border border-jade/30 bg-[rgba(6,12,14,0.82)] backdrop-blur-md text-jade hover:bg-jade/15 hover:border-jade/55 transition-colors cursor-clicker shadow-[0_0_20px_rgba(0,217,146,0.12)]", children: _jsx(ArrowUp, { className: "w-4 h-4" }) })) })] }));
}
// ─── Page ───────────────────────────────────────────────────────────
export default function BillingSuccessPage() {
    ...
    const [cardCredits, setCardCredits] = React.useState(null);
    ...
    return (_jsxs(_Fragment, { children: [_jsx(AmbientLayer, {}), _jsx(BackToTop, {}), _jsxs("div", { className: "relative", children: [_jsx(HeroSection, { planLabel: planFullLabel, reduceMotion: !!reduceMotion, credits: cardCredits }), _jsx(PerksTimeline, { perks: perks, reduceMotion: !!reduceMotion }), _jsx(CtaSection, { planLabel: planFullLabel }), _jsx(FooterStrip, { sessionId: sessionId })] })] }));
}
// ─── Ambient backdrop ──────────────────────────────────────────────
...
// ─── Hero section ───────────────────────────────────────────────────
function HeroSection({ planLabel, reduceMotion, credits, }) {
