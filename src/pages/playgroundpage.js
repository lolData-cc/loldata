...
function getTzParts(d, timeZone = TZ) {
...
function dailyIndex(len, mode, dateKey) {
...
export default function PlaygroundPage() {
        ...
        const load = async () => {
            try {
                ...
                const list = Object.values(data.data)
                    ...
                    key: c.key,
                    name: c.name,
                    spells: c.spells?.map((s) => ({ id: s.id, name: s.name })) || [],
                }))
    ...
    return (_jsxs("div", { className: "min-h-screen relative overflow-hidden flex", children: [_jsx("div", { className: "absolute inset-0", style: {
                    backgroundImage: "linear-gradient(rgba(0,217,146,0.03) 1px, transparent 1px), linear-gradient(90deg, rgba(0,217,146,0.03) 1px, transparent 1px)",
                    backgroundSize: "50px 50px",
                    maskImage: "radial-gradient(ellipse 80% 50% at 50% 50%, black, transparent)",
                    WebkitMaskImage: "radial-gradient(ellipse 80% 50% at 50% 50%, black, transparent)",
                } }), _jsxs("div", { className: "relative z-10 w-64 p-6 flex flex-col gap-4", children: [_jsxs("div", { className: "mb-2", children: [_jsx("h2", { className: "text-sm font-bold tracking-widest uppercase mb-1", style: {
                                    color: "#00d992",
                                    textShadow: "0 0 5px #00d992cc",
                                }, children: "GAME MODE" }), _jsx("div", { className: "h-px", style: { background: "linear-gradient(90deg, #00d99280, transparent)" } })] }), _jsxs("div", { className: "relative flex flex-col gap-3", children: [_jsx("div", { className: "absolute left-0 w-full h-14 transition-all duration-500 ease-out pointer-events-none", style: {
                                ...
                                } }), _jsxs("button", { onClick: () => setGameMode("champion"), className: "relative px-5 py-4 font-mono text-sm uppercase tracking-wider text-left transition-all duration-300 group h-14", style: {
                                ...
                                }, children: [_jsxs("div", { className: "flex items-center gap-3", children: [_jsx("span", { className: `w-2 h-2 rounded-full transition-all duration-300 ${gameMode === "champion" ? "animate-pulse" : ""}`, style: {
                                                    backgroundColor: gameMode === "champion" ? "#00d992" : "#148460",
                                                    boxShadow: gameMode === "champion" ? "0 0 8px #00d992" : "none",
                                                } }), _jsx("span", { className: "font-semibold", children: "Champion" })] }), gameMode === "champion" && (_jsx("div", { className: "absolute left-0 top-0 bottom-0 w-1 transition-all duration-300", style: {
                                            backgroundColor: "#00d992",
                                            boxShadow: "0 0 10px #00d992",
                                        } }))] }), _jsxs("button", { onClick: () => setGameMode("icon"), className: "relative px-5 py-4 font-mono text-sm uppercase tracking-wider text-left transition-all duration-300 group h-14", style: {
                                ...
                                }, children: [_jsxs("div", { className: "flex items-center gap-3", children: [_jsx("span", { className: `w-2 h-2 rounded-full transition-all duration-300 ${gameMode === "icon" ? "animate-pulse" : ""}`, style: {
                                                    backgroundColor: gameMode === "icon" ? "#00d992" : "#148460",
                                                    boxShadow: gameMode === "icon" ? "0 0 8px #00d992" : "none",
                                                } }), _jsx("span", { className: "font-semibold", children: "Ability Icon" })] }), gameMode === "icon" && (_jsx("div", { className: "absolute left-0 top-0 bottom-0 w-1 transition-all duration-300", style: {
                                            backgroundColor: "#00d992",
                                            boxShadow: "0 0 10px #00d992",
                                        } }))] })] }), _jsx("div", { className: "mt-auto pt-6", children: _jsx("div", { className: "text-[10px] font-mono tracking-wider", style: { color: "#6b8a99" }, children: "LOLDATADLE_v2.077" }) })] }), _jsxs("div", { className: "flex-1 pl-4 pr-8 py-8 relative z-10", children: [gameMode === "champion" && _jsx(ChampionGame, { champs: champs }), gameMode === "icon" && _jsx(IconGame, { champs: champs })] })] }));
}
function ChampionGame({ champs }) {
    ...
    const crispCanvasRef = useRef(null);
    ...
    const morphStartPixelRef = useRef(START_PIXEL_SIZE);
    ...
    const nameIndex = useMemo(() => {
        ...
        if (wukong)
            map.set(normalizeName("wukong"), wukong);
        return map;
    }, [champs]);
    useEffect(() => {
        if (!answer)
    ...
    const startMorphAnimation = () => {
        ...
        const animate = (currentTime) => {
            if (!morphStartTimeRef.current)
                return;
            const elapsed = currentTime - morphStartTimeRef.current;
            const progress = Math.min(elapsed / REVEAL_FADE_MS, 1);
            const easeOutCubic = 1 - Math.pow(1 - progress, 3);
            const newPixelSize = Math.max(MIN_PIXEL_SIZE, morphStartPixelRef.current - (morphStartPixelRef.current - MIN_PIXEL_SIZE) * easeOutCubic);
    ...
    function setupCanvas(canvas) {
        if (!canvas)
            return { canvas: null, ctx: null, dpr: 1 };
        const cssW = 176;
        const cssH = 176;
    ...
    function drawCrispOnCanvas(canvas) {
    ...
    return (_jsxs("div", { className: "mx-auto max-w-xl", children: [_jsxs("div", { className: "mb-8 flex items-start justify-between", children: [_jsxs("div", { children: [_jsx("h1", { className: "text-3xl font-bold tracking-wider uppercase mb-1", style: {
                                    color: "#00d992",
                                    textShadow: "0 0 5px #00d992cc, 0 0 10px #00d99280, 0 0 20px #00d99250",
                                }, children: "CHAMPION SCAN" }), _jsx("p", { className: "text-xs text-[#6b8a99] font-mono tracking-widest", children: "IDENTIFICATION PROTOCOL" })] }), _jsx("div", { className: "flex flex-col items-end gap-2", children: _jsxs("div", { className: "flex items-center gap-2 text-xs font-mono", children: [_jsx("span", { className: "text-[#6b8a99] tracking-wider", children: "ATTEMPTS:" }), _jsx("span", { className: "font-bold text-lg tabular-nums", style: {
                                        color: "oklch(0.78 0.22 35)",
                                        textShadow: "0 0 5px oklch(0.78 0.22 35 / 0.8), 0 0 10px oklch(0.78 0.22 35 / 0.5)",
                                    }, children: attempts.toString().padStart(2, "0") })] }) })] }), _jsxs("div", { className: "relative p-6 backdrop-blur-xl", style: {
                ...
                }, children: [_jsx("div", { className: "absolute top-0 left-0 w-4 h-4 border-t-2 border-l-2", style: { borderColor: "#00d992" } }), _jsx("div", { className: "absolute top-0 right-0 w-4 h-4 border-t-2 border-r-2", style: { borderColor: "#00d992" } }), _jsx("div", { className: "absolute bottom-0 left-0 w-4 h-4 border-b-2 border-l-2", style: { borderColor: "#00d992" } }), _jsx("div", { className: "absolute bottom-0 right-0 w-4 h-4 border-b-2 border-r-2", style: { borderColor: "#00d992" } }), err && (_jsxs("div", { className: "mb-4 p-3 font-mono text-xs", style: {
                            border: "1px solid oklch(0.65 0.25 25 / 0.5)",
                            backgroundColor: "oklch(0.65 0.25 25 / 0.1)",
                            color: "oklch(0.65 0.25 25)",
                        }, children: [_jsx("span", { style: { color: "oklch(0.78 0.22 35)" }, children: "[ERROR]" }), " ", err] })), !err && (_jsxs(_Fragment, { children: [_jsx("div", { className: "mb-6 flex justify-center", children: _jsxs("div", { className: "relative", children: [_jsx("div", { className: "absolute -inset-2 blur-xl", style: {
                                                background: "linear-gradient(135deg, #00d99233 0%, #14846033 50%, oklch(0.78 0.22 35 / 0.2) 100%)",
                                            } }), _jsxs("div", { className: "relative h-44 w-44 overflow-hidden", style: {
                                                ...
                                                boxShadow: "0 0 5px #00d99280, 0 0 10px #00d99250, 0 0 20px #00d99230, inset 0 0 10px #00d99220",
                                                    ...
                                                    } }), _jsx("canvas", { ref: pixelCanvasRef, className: "h-full w-full relative z-10", "aria-label": "Who's that champion?" }), _jsx("canvas", { ref: crispCanvasRef, className: "pointer-events-none absolute inset-0 h-full w-full object-cover z-20", style: {
                                                        opacity: crispMounted ? (crispVisible ? 1 : 0) : 0,
                                                        transition: `opacity ${REVEAL_FADE_MS}ms ease-out`,
                                                        willChange: "opacity",
                                                    } }), _jsxs("div", { className: "absolute top-0 left-0 px-2 py-1 text-[10px] font-mono z-30 flex items-center gap-1", style: {
                                                        backgroundColor: "rgba(0, 0, 0, 0.8)",
                                                        borderRight: "1px solid #00d99280",
                                                        borderBottom: "1px solid #00d99280",
                                                    }, children: [_jsx("span", { className: `w-1.5 h-1.5 rounded-full ${status === "playing" ? "animate-pulse" : ""}`, style: {
                                                                backgroundColor: status === "playing" ? "#00d992" : status === "won" ? "#10b981" : "oklch(0.78 0.22 35)",
                                                            } }), _jsx("span", { className: "tracking-wider", style: { color: "#00d992" }, children: status === "playing" ? "SCANNING" : status === "won" ? "MATCH" : "REVEALED" })] })] })] }) }), _jsxs("form", { onSubmit: onSubmit, className: "flex gap-2 mb-4", children: [_jsxs("div", { className: "flex-1 relative", children: [_jsx("input", { ref: inputRef, type: "text", onKeyDown: onKeyDown, placeholder: "ENTER CHAMPION NAME...", className: "w-full px-4 py-2.5 font-mono text-sm uppercase tracking-wide outline-none transition-all disabled:opacity-30 disabled:cursor-not-allowed cursor-clicker", style: {
                                                ...
                                                }, value: guess, onChange: (e) => setGuess(e.target.value), disabled: !answer || status !== "playing", autoFocus: true }), suggestions.length > 0 && status === "playing" && (_jsx("div", { className: "absolute left-0 right-0 mt-1 max-h-56 overflow-auto border font-mono text-sm z-50", style: {
                                                    backgroundColor: "#0f1d24",
                                                    borderColor: "#00d99250",
                                                    boxShadow: "0 10px 20px rgba(0,0,0,0.3)",
                                                }, children: suggestions.map((c, i) => (_jsx("button", { type: "button", onMouseEnter: () => setHoverIdx(i), onMouseLeave: () => setHoverIdx(-1), onClick: () => pickSuggestion(c), className: "w-full text-left px-3 py-2 transition-colors", style: {
                                                    ...
                                                    }, children: c.name }, c.id))) })), _jsx("div", { className: "absolute right-2 top-1/2 -translate-y-1/2 text-xs font-mono", style: { color: "#00d99250" }, children: ">>" })] }), _jsx("button", { type: "submit", className: "px-6 py-2.5 font-mono text-sm uppercase tracking-wider font-bold transition-all disabled:opacity-30 disabled:cursor-pointer cursor-clicker", style: {
                                            backgroundColor: "#00d992",
                                            border: "1px solid #00d992",
                                            color: "#040a0c",
                                            boxShadow: "0 0 5px #00d99280, 0 0 10px #00d99250, 0 0 20px #00d99230, inset 0 0 10px #00d99220",
                                        }, disabled: !answer || status !== "playing" || guess.trim().length === 0, children: "SCAN" }), _jsx("button", { type: "button", onClick: giveUp, className: "px-4 py-2.5 font-mono text-sm uppercase tracking-wider transition-all disabled:opacity-30 disabled:cursor-pointer cursor-clicker", style: {
                                        ...
                                        }, disabled: !answer || status !== "playing", children: "ABORT" })] }), _jsxs("div", { className: "min-h-[60px]", children: [status === "won" && answer && (_jsx("div", { className: "p-3 backdrop-blur-sm", style: {
                                            border: "1px solid #10b98180",
                                            backgroundColor: "#10b98120",
                                        }, children: _jsxs("div", { className: "flex items-start gap-3", children: [_jsx("div", { className: "text-xl", style: { color: "#10b981" }, children: "\u2713" }), _jsxs("div", { className: "flex-1", children: [_jsx("div", { className: "font-mono text-xs tracking-wider mb-1", style: { color: "#10b981" }, children: "[MATCH CONFIRMED]" }), _jsxs("div", { className: "font-mono", style: { color: "oklch(0.98 0.01 180)" }, children: ["Target identified as", " ", _jsx("span", { className: "font-bold", style: {
                                                                        color: "#00d992",
                                                                        textShadow: "0 0 5px #00d992cc, 0 0 10px #00d99280",
                                                                    }, children: answer.name })] })] })] }) })), status === "revealed" && answer && (_jsx("div", { className: "p-3 backdrop-blur-sm", style: {
                                            border: "1px solid oklch(0.78 0.22 35 / 0.5)",
                                            backgroundColor: "oklch(0.78 0.22 35 / 0.1)",
                                        }, children: _jsxs("div", { className: "flex items-start gap-3", children: [_jsx("div", { className: "text-xl", style: { color: "oklch(0.78 0.22 35)" }, children: "!" }), _jsxs("div", { className: "flex-1", children: [_jsx("div", { className: "font-mono text-xs tracking-wider mb-1", style: { color: "oklch(0.78 0.22 35)" }, children: "[SCAN ABORTED]" }), _jsxs("div", { className: "font-mono text-sm", style: { color: "oklch(0.98 0.01 180)" }, children: ["Target was", " ", _jsx("span", { className: "font-bold", style: {
                                                                        color: "oklch(0.78 0.22 35)",
                                                                        textShadow: "0 0 5px oklch(0.78 0.22 35 / 0.8), 0 0 10px oklch(0.78 0.22 35 / 0.5)",
                                                                    }, children: answer.name })] })] })] }) })), status === "playing" && attempts > 0 && (_jsx("div", { className: "p-3 backdrop-blur-sm", style: {
                                            border: "1px solid #14846080",
                                            backgroundColor: "#14846020",
                                        }, children: _jsxs("div", { className: "flex items-start gap-3", children: [_jsx("div", { className: "text-xl", style: { color: "#148460" }, children: "\u00D7" }), _jsxs("div", { className: "flex-1", children: [_jsx("div", { className: "font-mono text-xs tracking-wider mb-1", style: { color: "#148460" }, children: "[NO MATCH]" }), _jsx("div", { className: "font-mono text-sm", style: { color: "oklch(0.98 0.01 180)" }, children: "Enhancing image resolution... Try again." })] })] }) }))] })] }))] })] }));
}
function IconGame({ champs }) {
    const [answer, setAnswer] = useState(null);
    const [guess, setGuess] = useState("");
    const [attempts, setAttempts] = useState(0);
    const [status, setStatus] = useState("idle");
    ...
    return (_jsxs("div", { className: "mx-auto max-w-xl", children: [_jsxs("div", { className: "mb-8 flex items-start justify-between", children: [_jsxs("div", { children: [_jsx("h1", { className: "text-3xl font-bold tracking-wider uppercase mb-1", style: {
                                    color: "#00d992",
                                    textShadow: "0 0 5px #00d992cc, 0 0 10px #00d99280, 0 0 20px #00d99250",
                                }, children: "ABILITY SCAN" }), _jsx("p", { className: "text-xs text-[#6b8a99] font-mono tracking-widest", children: "ICON RECOGNITION PROTOCOL" })] }), _jsx("div", { className: "flex flex-col items-end gap-2", children: _jsxs("div", { className: "flex items-center gap-2 text-xs font-mono", children: [_jsx("span", { className: "text-[#6b8a99] tracking-wider", children: "ATTEMPTS:" }), _jsx("span", { className: "font-bold text-lg tabular-nums", style: {
                                        color: "oklch(0.78 0.22 35)",
                                        textShadow: "0 0 5px oklch(0.78 0.22 35 / 0.8), 0 0 10px oklch(0.78 0.22 35 / 0.5)",
                                    }, children: attempts.toString().padStart(2, "0") })] }) })] }), _jsxs("div", { className: "relative p-6 backdrop-blur-xl", style: {
                    backgroundColor: "rgba(10, 20, 25, 0.5)",
                    ...
                    boxShadow: "0 0 5px #00d99280, 0 0 10px #00d99250, 0 0 20px #00d99230, inset 0 0 10px #00d99220",
                            ...
                            color: "oklch(0.65 0.25 25)",
                                                ...
                                                boxShadow: "0 0 5px #00d99280, 0 0 10px #00d99250, 0 0 20px #00d99230, inset 0 0 10px #00d99220",
                                                        ...
                                                        background: "repeating-linear-gradient(0deg, rgba(0, 0, 0, 0.15), rgba(0, 0, 0, 0.15) 1px, transparent 1px, transparent 2px)",
                                                    } }), _jsx("canvas", { ref: pixelCanvasRef, className: "h-full w-full relative z-10", "aria-label": "Which champion has this ability?" }), _jsx("canvas", { ref: crispCanvasRef, className: "pointer-events-none absolute inset-0 h-full w-full object-cover z-20", style: {
                                                        opacity: crispMounted ? (crispVisible ? 1 : 0) : 0,
                                                        transition: `opacity ${REVEAL_FADE_MS}ms ease-out`,
                                                        willChange: "opacity",
                                                    } }), _jsxs("div", { className: "absolute top-0 left-0 px-2 py-1 text-[10px] font-mono z-30 flex items-center gap-1", style: {
                                                        ...
                                                        borderBottom: "1px solid #00d99280",
                                                                ...
                                                                backgroundColor: status === "playing" ? "#00d992" : status === "won" ? "#10b981" : "oklch(0.78 0.22 35)",
                                                            } }), _jsx("span", { className: "tracking-wider", style: { color: "#00d992" }, children: status === "playing" ? "ANALYZING" : status === "won" ? "MATCH" : "REVEALED" })] })] })] }) }), _jsxs("form", { onSubmit: onSubmit, className: "flex gap-2 mb-4", children: [_jsxs("div", { className: "flex-1 relative", children: [_jsx("input", { ref: inputRef, type: "text", placeholder: "ENTER CHAMPION NAME...", className: "w-full px-4 py-2.5 font-mono text-sm uppercase tracking-wide outline-none transition-all disabled:opacity-30 disabled:cursor-not-allowed", style: {
                                                    backgroundColor: "#0f1d24",
                                                    border: "1px solid #00d99250",
                                                    color: "oklch(0.98 0.01 180)",
                                                }, onFocus: (e) => {
                                                    ...
                                                    e.target.style.borderColor = "#00d99250";
                                                    e.target.style.boxShadow = "none";
                                                }, value: guess, onChange: (e) => setGuess(e.target.value), disabled: !answer || status !== "playing", autoFocus: true }), _jsx("div", { className: "absolute right-2 top-1/2 -translate-y-1/2 text-xs font-mono", style: { color: "#00d99250" }, children: ">>" })] }), _jsx("button", { type: "submit", className: "px-6 py-2.5 font-mono text-sm uppercase tracking-wider font-bold transition-all disabled:opacity-30 disabled:cursor-not-allowed", style: {
                                            backgroundColor: "#00d992",
                                            border: "1px solid #00d992",
                                            color: "#040a0c",
                                            boxShadow: "0 0 5px #00d99280, 0 0 10px #00d99250, 0 0 20px #00d99230, inset 0 0 10px #00d99220",
                                        }, disabled: !answer || status !== "playing" || guess.trim().length === 0, children: "SCAN" }), _jsx("button", { type: "button", onClick: giveUp, className: "px-4 py-2.5 font-mono text-sm uppercase tracking-wider transition-all disabled:opacity-30 disabled:cursor-not-allowed", style: {
                                            backgroundColor: "#0a1419",
                                            border: "1px solid oklch(0.78 0.22 35 / 0.5)",
                                            color: "oklch(0.78 0.22 35)",
                                        }, onMouseEnter: (e) => {
                                            ...
                                            border: "1px solid #10b98180",
                                            backgroundColor: "#10b98120",
                                        }, children: _jsxs("div", { className: "flex items-start gap-3", children: [_jsx("div", { className: "text-xl", style: { color: "#10b981" }, children: "\u2713" }), _jsxs("div", { className: "flex-1", children: [_jsx("div", { className: "font-mono text-xs tracking-wider mb-1", style: { color: "#10b981" }, children: "[MATCH CONFIRMED]" }), _jsxs("div", { className: "font-mono", style: { color: "oklch(0.98 0.01 180)" }, children: ["Ability belongs to", " ", _jsx("span", { className: "font-bold", style: {
                                                                        color: "#00d992",
                                                                        textShadow: "0 0 5px #00d992cc, 0 0 10px #00d99280",
                                                                    }, children: answer.champion.name })] }), attempts > 0 && (_jsxs("div", { className: "font-mono text-xs mt-1", style: { color: "#6b8a99" }, children: ["You took ", attempts, " ", attempts === 1 ? "try" : "tries", " before aborting."] }))] })] }) })), status === "revealed" && answer && (_jsx("div", { className: "p-3 backdrop-blur-sm", style: {
                                            border: "1px solid oklch(0.78 0.22 35 / 0.5)",
                                            backgroundColor: "oklch(0.78 0.22 35 / 0.1)",
                                        }, children: _jsxs("div", { className: "flex items-start gap-3", children: [_jsx("div", { className: "text-xl", style: { color: "oklch(0.78 0.22 35)" }, children: "!" }), _jsxs("div", { className: "flex-1", children: [_jsx("div", { className: "font-mono text-xs tracking-wider mb-1", style: { color: "oklch(0.78 0.22 35)" }, children: "[SCAN ABORTED]" }), _jsxs("div", { className: "font-mono text-sm", style: { color: "oklch(0.98 0.01 180)" }, children: ["Ability belongs to", " ", _jsx("span", { className: "font-bold", style: {
                                                                        color: "oklch(0.78 0.22 35)",
                                                                        textShadow: "0 0 5px oklch(0.78 0.22 35 / 0.8), 0 0 10px oklch(0.78 0.22 35 / 0.5)",
                                                                    }, children: answer.champion.name })] }), _jsx("div", { className: "font-mono text-xs mt-1", style: { color: "#6b8a99" }, children: answer.spell.name })] })] }) })), status === "playing" && attempts > 0 && (_jsx("div", { className: "p-3 backdrop-blur-sm", style: {
                                            border: "1px solid #14846080",
                                            backgroundColor: "#14846020",
                                        }, children: _jsxs("div", { className: "flex items-start gap-3", children: [_jsx("div", { className: "text-xl", style: { color: "#148460" }, children: "\u00D7" }), _jsxs("div", { className: "flex-1", children: [_jsx("div", { className: "font-mono text-xs tracking-wider mb-1", style: { color: "#148460" }, children: "[NO MATCH]" }), _jsx("div", { className: "font-mono text-sm", style: { color: "oklch(0.98 0.01 180)" }, children: "Enhancing icon resolution... Try again." })] })] }) }))] })] }))] })] }));
}
