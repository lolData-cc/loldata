...
export function isDesktopLogin(): boolean {
...
export function stashDesktopLogin(): void {
  if (new URLSearchParams(window.location.search).get("desktop") === "1") {
    localStorage.setItem(KEY, "1")
  }
}

export function clearDesktopLogin(): void {
 ...
 */
export function buildHandoffLink(session: HandoffSession | null, plan: string | null): string | null {
