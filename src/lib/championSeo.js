...
export const CHAMPION_TABS = ["overview", "build", "duos", "counters", "pros", "guides"];
...
export const INDEXABLE_TABS = ["overview", "build", "duos", "counters", "pros"];
...
export function championPath(slug, tab = "overview") {
