// src/data/champion-roles.ts

// puoi usare gli id di DDragon (es. "Aatrox", "Ahri", "Alistar"...)
...
export const MID_CHAMPIONS = [
  "TwistedFate", "Ekko", "Zed", "Irelia", "Morgana", "Yasuo", "Akali", "Ryze", "Orianna", "Cassiopeia", "Leblanc", "Diana", "Veigar", "Syndra", "Yone", "Vladimir", "Kassadin", "Ahri",
  "Lux", "Taliyah", "Hwei", "Sylas", "Annie", "Viktor", "Xerath", "Katarina", "Azir", "Qiyana", "Galio", "Zoe", "AurelionSol", "Fizz", "Akshan", "Vex", "Anivia", "Aurora", "Lissandra",
  "Malzahar", "Mel"
]
...
export const SUP_CHAMPIONS = [
  "Blitzcrank", "Thresh", "Morgana", "Sona", "Pantheon", "Senna", "Karma", "Janna", "Lux", "Bard", "Alistar", "Poppy", "Xerath", "Nautilus", "Zilean", "Brand", "TahmKench", "Pyke", "Swain",
  "Zyra", "Braum", "Seraphine", "VelKoz", "Leona", "Soraka", "Rakan", "Taric", "Nami", "Neeko", "Milio", "Lulu", "Maokai", "RenataGlasc", "Mel", "Rell", "Yuumi"
]
