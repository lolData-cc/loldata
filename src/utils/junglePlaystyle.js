export function getReadableJunglePlaystyleTag(tag) {
    switch (tag) {
...
export function getJunglePlaystyleTagClasses(tag) {
    switch (tag) {
        case "played_for_topside":
...
export function getReadableStartingCamp(camp) {
    switch (camp) {
        case "blue":
            return "START BLUE";
        case "red":
...
export function getStartingCampClasses(camp) {
...
export function getReadableInvade(invade) {
    switch (invade) {
        case "invade":
            return "INVADE";
        case "no_invade":
...
export function getInvadeClasses(invade) {
    switch (invade) {
        case "invade":
            return "text-rose-300/90 border-rose-400/60";
        default:
