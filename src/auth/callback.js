...
export default function AuthCallback() {
    ...
    if (error) {
        return (_jsx("div", { className: "w-screen h-screen bg-liquirice text-flash font-jetbrains flex items-center justify-center px-4", children: _jsxs("div", { className: "relative w-full max-w-md overflow-hidden px-8 py-8", style: {
                    background: "#040A0C",
                ...
                }, children: [_jsx("div", { className: "absolute left-0 top-0 bottom-0 w-[2px]", style: { background: "#ff6286" } }), _jsxs("div", { className: "flex items-center gap-2 text-[10px] tracking-[0.25em] uppercase mb-4 text-error/70", children: [_jsx("span", { style: { fontSize: "8px" }, children: "\u25C8" }), " :: AUTH FAILED ::"] }), _jsx("h1", { className: "font-mechano text-xl text-flash/90 mb-3", children: "Sign-in didn\u2019t complete" }), _jsx("p", { className: "text-[12px] text-flash/55 leading-relaxed mb-6 break-words", children: error }), _jsx("button", { type: "button", onClick: () => navigate("/login", { replace: true }), className: "cursor-pointer select-none px-5 py-2 text-[12px] uppercase tracking-[0.15em] text-jade", style: {
